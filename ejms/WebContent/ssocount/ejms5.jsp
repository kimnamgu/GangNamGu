...
<table cellpadding="0" cellspacing="0" border="0">
	<tr>
		<td width="8px"><img src="/ssocount/images/left_5.gif" alt="" /></td>
		<td width="182px" background="/ssocount/images/bg_5.gif" align="center">
			<table cellpadding="0" cellspacing="0" border="0" style="border-collapse: collapse;">
				<tr>
					<td height="32px" align="left"><a href="javascript:goEJMS('')"><img src="/ssocount/images/e_title_5.gif" border="0" alt=""/></a></td>
				</tr>
				<tr>
					<td align="center" height="45px">
						<table cellpadding="0" cellspacing="0" border="0" style="border-collapse: collapse;">
							<tr height="18px">
								<td width="60px"><img src="/ssocount/images/icon_5.gif" style="vertical-align: middle;" alt=""/>&nbsp;<a href="javascript:goEJMS('deliv')"><font color="#434343">배부하기</font></a></td>
								<td width="20px" align="center"><a href="javascript:goEJMS('deliv')"><font color="#e30000" id="deliCount">0</font></a></td>
								<td width="10px"></td>
								<td width="60px"><img src="/ssocount/images/icon_5.gif" style="vertical-align: middle;" alt=""/>&nbsp;<a href="javascript:goEJMS('input')"><font color="#434343">입력하기</font></a></td>
								<td width="20px" align="center"><a href="javascript:goEJMS('input')"><font color="#e30000" id="inputCount">0</font></a></td>
							</tr>
							<tr height="18px">
								<td><img src="/ssocount/images/icon_5.gif" style="vertical-align: middle;" alt=""/>&nbsp;<a href="javascript:goEJMS('reqlist')"><font color="#434343" style="letter-spacing:6px">신청서</font></a></td>
								<td align="center"><a href="javascript:goEJMS('reqlist')"><font color="#e30000" id="reqCount">0</font></a></td>
								<td></td>
								<td><img src="/ssocount/images/icon_5.gif" style="vertical-align: middle;" alt=""/>&nbsp;<a href="javascript:goEJMS('rchlist')"><font color="#434343">설문조사</font></a></td>
		...
		<td width="8px"><img src="/ssocount/images/right_5.gif" alt=""/></td>
	</tr>
</table>
