  ...
  <tr>
    ...
    <td width="744" valign="top" height="514">
      <table width="744" border="0" cellspacing="0" cellpadding="0">
        <!--타이틀-->
        <tr>
          <td background="/images/common/title_bg.gif" height="38" width="644"><img src="/images/collect/title_25.gif" alt="공통양식가져오기"></td>
        </tr>
        <tr>
          ...
          <td valign="top">
            <table width="744" border="0" cellspacing="0" cellpadding="0" align="center">
              <tr>
                ...
                <td valign="top" height="400"><iframe name="iframe1" src="/formatGetCommFrame.do" frameborder="0" width="100%" height="100%" scrolling="auto" marginwidth=0 marginheight=0 title="양식목록"></iframe></td>
              </tr>
              <tr>
