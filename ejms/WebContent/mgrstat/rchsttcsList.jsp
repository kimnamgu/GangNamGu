  ...
  <tr> 
    ...
    <td width="843" valign="top"> 
      <table width="843" border="0" cellspacing="0" cellpadding="0">
        <!--타이틀-->
        <tr> 
          <td background="/images/common/title_bg.gif" height="38"><img src="/images/admin/title_09.gif" alt=""></td>
                  ...
                  <table width="820" border="0" cellspacing="2" cellpadding="0" bgcolor="#ECF3F9" height="42">
                    <tr> 
                      <td bgcolor="#FFFFFF" style="padding:3 0 3 0;"> 
                        <!--마감시한/알림말 테이블 시작-->
                        <html:form method="POST" action="/rchsttcsList">
                        <table width="810" border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="#F7F7F7" height="32">
                          <tr> 
                            ...
                            <td height="20" width="370">
															...
															<% ((nexti.ejms.statistics.form.RchsttcsForm)request.getAttribute("rchsttcsForm")).setOrggbn((String)session.getAttribute("user_gbn")); %>
															<% } %>
															<logic:notEqual name="rchsttcsForm" property="orggbn" value="">
																<html:select property="orggbn_dt" style="width:250px;background-color:white" onchange="submit()">
																	<jsp:useBean id="orggbn_dt" class="nexti.ejms.list.form.DeptDetailListForm">
																		<bean:define id="orggbn" name="rchsttcsForm" property="orggbn"/>
                            ...
                            <td height="20" width="100">
                            	<html:select property="gbn" style="width:80;background-color:white" onchange="submit()">
																...
																<html:option value="2">설문양식</html:option>
                            	</html:select>
                            </td>
                            <td></td>
                          </tr>
              ...
              <tr> 
                <td valign="top"> 
                  ...
                  <table width="820" border="0" cellspacing="0" cellpadding="0" id="tbl">
                    ...
                    <tr>                    
                      <logic:equal name="rchsttcsForm" property="gbn" value="0">
                    		<td class="list_t" width="100">연번</td>
	                      <td class="list_t" width="240">부서명</td>
	                      <td class="list_t" width="240">설문조사회수</td>
	                      <td class="list_t" width="240">응답회수</td>
                    	</logic:equal>
                    	<logic:equal name="rchsttcsForm" property="gbn" value="1">
                    		<td class="list_t" width="100">연번</td>
	                      <td class="list_t" width="240">부서명</td>
	                      <td class="list_t" width="240">사용자명</td>
	                      <td class="list_t" width="240">설문조사회수</td>
                    	</logic:equal>
                    	<logic:equal name="rchsttcsForm" property="gbn" value="2">
                    		<td class="list_t" width="100">조사부서</td>
	                      <td class="list_t" width="200">설문제목</td>
	                      <td class="list_t" width="280">설문개요</td>
	                      <td width="240">
		                      <table width="240" border="0" cellspacing="0" cellpadding="0">
		                      	<tr>
		                      		<td class="list_t" width="80">시작일</td>
		                      		<td class="list_t" width="80">종료일</td>
		                      		<td class="list_t" width="80">응답회수</td>
		                      	</tr>
		                      </table>
	                      </td>
                    	</logic:equal>
                    ...
                    <logic:notEmpty name="rchsttcsForm" property="list">
											<logic:iterate id="list" name="rchsttcsForm" property="list" indexId="i">
		                    <tr <% if (i.intValue() % 2 != 0) out.print("class=\"list_bg3\" onMouseOut=\"this.style.background='#F5FAFF'\"");%> onMouseOut="this.style.background='#ffffff'" onMouseOver="this.style.background='#FFFAD1'">
		                      <logic:equal name="rchsttcsForm" property="gbn" value="0">
			                      ...
			                      <td class="list_l"><bean:write name="list" property="rchcount"/></td>
                    	...
                    	<bean:define id="list" name="rchsttcsForm" property="list" type="java.util.ArrayList"/>
                    	<tr <% if (list.size() % 2 != 0 & false) out.print("class=\"list_bg3\" onMouseOut=\"this.style.background='#F5FAFF'\"");%> onMouseOut="this.style.background='#ffffff'" onMouseOver="this.style.background='#FFFAD1'">
	                      ...
	                      <td class="list_l">&nbsp;</td>
	                      <logic:equal name="rchsttcsForm" property="gbn" value="0">
	                      	<td class="list_l"><bean:write name="rchsttcsForm" property="totrchcnt"/></td>
	                      	<td class="list_l"><bean:write name="rchsttcsForm" property="totanscnt"/></td>
	                      </logic:equal>
	                      <logic:equal name="rchsttcsForm" property="gbn" value="1">
		                      <td class="list_l"></td>
		                      <td class="list_l"><bean:write name="rchsttcsForm" property="totrchcnt"/></td>
	                      ...
	                      <logic:equal name="rchsttcsForm" property="gbn" value="2">
		                      <td class="list_l">설문조사회수 : <bean:write name="rchsttcsForm" property="totrchcnt"/></td>
	                      	<td class="list_l">응답회수 : <bean:write name="rchsttcsForm" property="totanscnt"/></td>
	                      </logic:equal>
	                    </tr>
	                    <tr> 
	                      <td colspan="4" class="list_bg2"></td>
                    ...
                    <logic:empty name="rchsttcsForm" property="list">
                    	<tr> 
