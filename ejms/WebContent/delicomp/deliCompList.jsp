...
<html:form action="/deliveryCompList" method="post">
  ...
  <tr> 
    ...
    <td width="843" valign="top"> 
      <table width="843" border="0" cellspacing="0" cellpadding="0">
        <!--타이틀-->
        <tr> 
          <td background="/images/common/title_bg.gif" height="38"><img src="/images/delivery/title_02.gif" alt=""></td>
            ...
            <table width="820" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <table width="820" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr> 
                      <td colspan="9" height="1"></td>
								      ...
								      <td width="195" class="list_t" align="center">문서제목</td>
								      <td width="55" class="list_t" align="center">진행상태</td>
								      <td width="95" class="list_t" align="center">배부일자</td>
								      ...
								      <td width="60" class="list_t" align="center">입력/배부</td>
								    </tr>
                    <tr> 
                      <td colspan="9" height="1"></td>
                    </tr>
                    ...
                    <tr> 
                      <td colspan="9" height="1"></td>
								...
								<logic:notEmpty name="deliveryCompForm" property="deliCompList">
								  <logic:iterate id="list" name="deliveryCompForm" property="deliCompList" indexId="i">
			              	...
			              	<logic:notEqual name="list" property="remaintime" value="마감시한 초과">
			              		<bean:write name="list" property="remaintime"/>
											...
											<td align="center" class="list_s"><bean:write name="list" property="inputperdeli"/></td>
                    </tr>
                    <tr> 
                      <td colspan="9" class="list_bg2"></td>
								...
								<logic:empty name="deliveryCompForm" property="deliCompList">
										<tr>
											<td colspan="9" align="center" class="list_s">검색된 목록이 없습니다</td>
										</tr>
										<tr>
								      <td colspan="9" class="list_bg2"></td>
								    </tr>
                		...
                		<tr>
                			<td align="right">
			                	<% if (request.getAttribute("initentry").equals("second")){ %>
												<a href="/deliveryCompList.do"><img src="/images/common/btn_distribution.gif" width="125" height="26" border="0" alt="배부문서가기"></a>
                				<% } %>
                			</td>
                		</tr>
                	</table>
              ...
              <tr>
                <td height="45" align="center">
                	<bean:define id="initentry" name="deliveryCompForm" property="initentry"/>
                	<bean:define id="sch_old_deptcd" name="deliveryCompForm" property="sch_old_deptcd"/>
                	<bean:define id="sch_deptnm" name="deliveryCompForm" property="sch_deptnm"/>
                	<%=nexti.ejms.util.commfunction.procPage_AddParam("/deliveryCompList.do","initentry="+(String)initentry+"&sch_old_deptcd="+(String)sch_old_deptcd+"&sch_deptnm="+(String)sch_deptnm,null,request.getAttribute("totalPage").toString(),request.getAttribute("currpage").toString())%>
                </td>
            	</tr>
            </table>
          </td>
