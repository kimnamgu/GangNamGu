...
function OnUploadCompleted( errorNumber, fileUrl, fileName, customMsg )
{
	switch ( errorNumber )
	{
		...
		case 201 :
			...
			alert( '동일한 이름의 파일이 존재합니다. 업로드된 파일의 이름이 "' + fileName + '" 으로 변경되었습니다.' ) ;
			break ;
		case 202 :
		...
		case 203 :
			...
			alert( "보안문제 발생. 업로드에 대한 권한이 없습니다. 서버관리자에게 문의하시기 바랍니다." ) ;
			return ;
		default :
			//alert( 'Error on file upload. Error number: ' + errorNumber ) ;
			alert( '파일업로드 중 에러가 발생하였습니다.. 에러코드: ' + errorNumber ) ;
			return ;
	}
