...
function goDataView(rchno)
{
	parent.document.location= "/researchView.do?rchno=" + rchno;
}

function goMyList(){
	parent.document.location= "/researchMyList.do";
}
</script>
</head>
...
<html:hidden property="treescroll"/>
  ...
  <tr> 
    <td> 
      ...
      <logic:iterate id="list" name="researchForm" property="listrch" indexId="i">	      
          ...
          <td class="list_s"><a class="list_s2" href="javascript:parent.showModalPopup('/researchPreview.do?mode=getused&rchno=<bean:write name="list" property="rchno"/>',700,750,0,0)"><bean:write name="list" property="title"/></a></td>
  ...
  <tr>
  	<td align="right"><br><a href="javascript:goMyList()"><img src="/images/common/btn_myresearch.gif" border="0" alt="내설문조사가기"></a></td>
  </tr>
  <tr> 
    <td height="20" align="center"><%=nexti.ejms.util.commfunction.procPage("/researchGetUsed.do",(java.util.HashMap)request.getAttribute("sch"),request.getAttribute("totalPage").toString(),request.getAttribute("currpage").toString())%></td>
  </tr>
</html:form>
</table>
</body>
