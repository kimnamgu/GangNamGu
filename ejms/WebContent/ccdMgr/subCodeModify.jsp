...
<!--
	...
	{		
		if (document.forms[0].ccd_sub_name.value.replace(" ","")=="")
		{
			alert("부코드명를 입력하여 주십시오.")
			document.forms[0].ccd_sub_name.focus();
			return;
		}
...
<html:hidden property="ccd_sub_cd"/>
                ...
                <td valign="top"> 
                  ...
                  <table width="644" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr> 
                      ...
                      <td class="bg2"></td>
                      <td class="t1"><bean:write name="codeForm" property="ccd_cd"/></td>
                    </tr>
                    <tr> 
                    ...
                    <tr> 
                      ...
                      <td class="bg2"></td>
                      <td class="t1"><bean:write name="codeForm" property="ccd_name"/></td>
                    </tr>
                    <tr> 
                      <td colspan="3" class="bg1"></td>
                    </tr>
										<tr> 
                    	<td width="120" class="s1"><img src="/images/common/dot_02.gif" width="15" height="11" align="absmiddle" alt="">부코드</td>
                      <td class="bg2"></td>
                      <td class="t1"><bean:write name="codeForm" property="ccd_sub_cd"/></td>
                    </tr>
                    <tr> 
                      <td colspan="3" class="bg1"></td>
                    </tr>
										<tr>
                      <td width="120" class="s1"><img src="/images/common/dot_02.gif" width="15" height="11" align="absmiddle" alt="">부코드명</td>
                      <td class="bg2"></td>
                      <td class="t1"><html:text property="ccd_sub_name" maxlength="50" style="width:95%"/></td>
                    </tr>
                    <tr> 
                      <td colspan="3" class="bg1"></td>
                    </tr>
										<tr>
                      <td width="120" class="s1"><img src="/images/common/dot_02.gif" width="15" height="11" align="absmiddle" alt="">부코드설명</td>
                      <td class="bg2"></td>
                      <td class="t1"><html:text property="ccd_desc" maxlength="50" style="width:95%"/></td>
                    </tr>
                    <tr> 
                      <td colspan="3" class="bg1"></td>
                    </tr>
