...
function checkSave(frm, mode) {	//행추가형 저장
	if(draglayer != "") {
		return;
	}
...
function checkSave2(frm, mode) {	//고정양식형,사용자지정
	if(draglayer != "") {
		return;
	}
...
function checkModify(frm,seq) {	
	...
	if(cnf) {
		...
		frm.seq.value = seq;
		frm.action = "/inputLineDataSave.do" + param;
		frm.submit();
	}
}
                    ...
                    <tr> 
                      ...
                      <td width="810" background="/images/common/select_bg.gif"> 
                        <table width="800" border="0" cellspacing="0" cellpadding="0" align="center">
                          <tr> 
                            <td width="94"><img src="/images/collect/s_m_01.gif" width="94" height="41" alt="취합문서정보" style="cursor:hand" onclick="location.href='/inputCollDocInfoView.do?formkind=<%=formkind%>&sysdocno=<%=sysdocno%>&formseq=<%=formseq%>&frmScrollTop=' + formFrame.document.body.scrollTop"></td>
                            ...
                            <td align="right" valign="bottom" style="padding:0 0 1 0;">
	                            ...
	                            <% } %>
															<img src="/images/common/btn_writeok_2.gif" alt="입력자료제출" style="cursor:hand" onclick="InputingComplete(<%=sysdocno%>, '/inputCollDocInfoView.do?formkind=<%=formkind%>&sysdocno=<%=sysdocno%>&formseq=<%=formseq%>&frmScrollTop=' + formFrame.document.body.scrollTop)">
															<img src="/images/common/btn_no.gif" alt="입력자료없음" style="cursor:hand" onclick="CollDocNotApplicable(<%=sysdocno%>, '/inputCollDocInfoView.do?formkind=<%=formkind%>&sysdocno=<%=sysdocno%>&formseq=<%=formseq%>&frmScrollTop=' + formFrame.document.body.scrollTop)">
...
<form action="/inputLineDataSave.do" method="POST" name="formatLineForm">
  ...
  <tr> 
	...
	<tr>
		<td>
			...
			<img src="/images/common/btn_b_del.gif" style="cursor:hand" onclick="click_deleteAll('/inputLineDataDel.do')" alt="">
		</td>
	</tr>
</table></form><br>
</logic:notEmpty>
...
<form action="/inputFixedDataSave.do" method="POST" name="formatFixedForm">
  ...
  <tr>
	...
	<tr>
		<td>
			...
			<img src="/images/common/btn_b_del.gif" style="cursor:hand" onclick="click_deleteAll('/inputFixedDataDel.do')" alt="">
			<img src="/images/common/btn_temp.gif" name="savebutton" style="cursor:hand" onclick="checkSave2(document.forms[0],'insert')" alt="">
		</td>
	</tr>
</table></form><br>
</logic:notEmpty>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="padding-left:20">
<html:form action="/inputDataBookSave.do" method="POST" enctype="multipart/form-data">
  	...
  	<td><!-- 양식데이터 나타낼 부분 시작-->
	            ...
	            <tr> 
	              <td colspan="5" class="list_bg4"></td>
			     	...
			     	<logic:iterate id="list" name="dataForm" property="dataList" indexId="i">
					      ...
					      <td class="list_l"><img src="/images/common/btn_del.gif" alt="삭제" style="cursor:hand" onclick="InputDeleteDataBookFrm('<bean:write name="list" property="sysdocno"/>', '<bean:write name="list" property="formseq"/>', '<bean:write name="list" property="fileseq"/>', '<bean:write name="list" property="filenm"/>')"></td>
					    </tr>
					    <tr> 
					      <td colspan="5" class="list_bg4"></td>
					    </tr>
	          ...
	          <table width="820" border="0" cellspacing="0" cellpadding="0">
	            ...
	            <tr> 
	              ...
	              <td colspan="5" class="t1" height="28"> 
	                ...
	                <img src="/images/common/btn_record.gif" width="50" height="21" align="absmiddle" alt="등록" style="cursor:hand" onclick="InputInsertDataBookFrm()">
	              </td>
	            </tr>
	            <tr> 
	      ...
	      <tr> 
	        <td>
	        	...
	        	<img src="/images/common/btn_b_del.gif" style="cursor:hand" onclick="click_deleteAll('/inputBookDataDel.do?sysdocno=' + sysdocno.value + '&formseq=' + formseq.value)" alt="">
	        </td>
	      </tr>
			</table>
  	</td><!-- 양식데이터 나타낼 부분 끝-->
