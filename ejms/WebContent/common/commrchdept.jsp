...
<script type="text/javascript" src="/script/commrchdept.js"></script>
</head>

<body bgcolor="#FFFFFF" text="#000000" style="margin: 0px 0px 0px 0px" onload="fullSizeWindow()">
<html:form action="/commrchdept" method="post">
  ...
  <tr> 
    ...
    <td width="744" height="364" valign="top"> 
      <table width="744" border="0" cellspacing="0" cellpadding="0">
        <!--타이틀-->
        <tr> 
          <td background="/images/common/title_bg.gif" height="38" width="644"><img src="/images/collect/title_22.gif" alt=""></td>
        </tr>
        <tr> 
              ...
              <tr>
                <td width="325" height="360" valign="top">
                	<div id="div_display0" style="display:block;"> 
	                  <table width="320" border="0" cellspacing="0" cellpadding="0">
	                    <tr> 
	                      ...
	                      <td width="94"><img src="/images/collect/tab_03_off.gif" width="74" height="28" onclick="divDisplay(1);addButton.onclick=addDept1;loadDistribute();subdeptChk.style.display='none'" style="cursor:hand" alt="배포목록"></td>
	                      <td width="150">
												<% if ( (session.getAttribute("user_gbn").equals("001") && nexti.ejms.common.appInfo.isSidoldap()) || "6280000".equals(nexti.ejms.common.appInfo.getRootid()) ){ //인천은 사용자구분 상관없이 다 보이도록%>
												<html:select name="commsubdeptForm" property="sch_orggbn" style="width:100px" onchange="orggbnChange(0)">
                                                    ...
                                                    <% if ( "6280000".equals(nexti.ejms.common.appInfo.getRootid()) ) { //인천은 사용자구분 상관없이 다 보이도록%>
	                      ...
	                      <td colspan="3"> 
	                        ...
	                        <table width="320" border="0" cellspacing="0" cellpadding="0" height="28" class="bg5" align="center">
	                          <tr align="middle">
	                            ...
	                            <td width="45"><a href="javascript:searchFormation()"><img src="/images/common/btn_s_search.gif" alt="검색"></a></td>
	                            <td width="5"></td>
	                          </tr>
	                        </table>
	                      </td>
                	...
                	<div id="div_display1" style="display:none;""> 
	                  <table width="320" border="0" cellspacing="0" cellpadding="0">
	                    <tr> 
	                      <td width="76"><img src="/images/collect/tab_02_off.gif" width="74" height="28" onclick="divDisplay(0);addButton.onclick=addDept;loadFormation();subdeptChk.style.display='block'" style="cursor:hand" alt="조직도"></td>
                      ...
                      <td colspan="2"> 
                        <table width="320" border="0" cellspacing="0" cellpadding="0"class="bg5" align="center">
                          ...
                          <tr align="<%="middle"%>" height="28"> 
                            ...
                            <td width="155"><input type="text" name="groupName" style="width:99%;" onkeypress="if(event.keyCode==13){event.returnValue=false;saveDistribute('insert', document.forms[0].groupName)}"/></td>
                ...
                <td colspan="3"> 
                  ...
                  <table width="744" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr bgcolor="#F6F6F6"> 
                      ...
                      <td bgcolor="#F6F6F6" width="500" style="padding-left:10"><b style="color:#FF5656"></b></td>
