 ...
 * 작성일: 2009.09.09
 * 작성자: 대리 서동찬
 * 모듈명: 입력하기 고정양식형 입력자료 전체삭제 action
 * 설명:
 */
...
public class InputFixedDataDelAction extends rootAction {
	...
	public ActionForward doService(
		...
		manager.deleteAllFormatFixedData(sysdocno, formseq, dept_code, user_id);
		...
		request.setAttribute("retpage", new String("inputformatfixed"));
