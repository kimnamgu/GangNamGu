...
public class FormatFixedDefAction extends rootPopupAction {
	...
	throws Exception {
		...
		if(type == 1) {
			...
			//완료되지 않은 제본자료형 업로드 파일 삭제
			if(formseq == fmgr.getNewCommFormatseq()) {
				flform.setFormseq(0);
		...
		return mapping.findForward("formatFixedDef");
	}
}