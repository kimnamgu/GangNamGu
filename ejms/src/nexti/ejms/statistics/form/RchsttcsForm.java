...
public class RchsttcsForm extends ActionForm {
	...
	public long getTotrchcnt() {
		return totrchcnt;
	}

	public void setTotrchcnt(long totrchcnt) {
		this.totrchcnt = totrchcnt;
	}
