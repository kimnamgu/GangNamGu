...
public class ResearchForm_gangnam extends ActionForm {
	...
	private String[] formtype 			= new String[50];   	//입력형태(1:단일 2:복수 3:단답 4:장문)
	...
	private String[] formtitleFileYN	= new String[50];		//문항제목첨부여부
	private String[] examcontFileYN		= new String[2500];		//보기제목첨부여부
	
	private String[] anscont;									//답변내용
	private String[] other				= new String[50];		//기타답변내용
