...
public class ResearchGetUsedAction extends rootAction {
	...
	public ActionForward doService(ActionMapping mapping, ActionForm form,
		...
		rchForm.setListrch(manager.getUsedRchList(Bean, start, end));
		...
		//화면으로 가져갈 값 설정
		int totalCount = manager.getUsedRchTotCnt(Bean);
