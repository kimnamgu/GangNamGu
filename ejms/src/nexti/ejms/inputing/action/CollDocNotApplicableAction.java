...
public class CollDocNotApplicableAction extends rootAction {
	...
	public ActionForward doService(
		...
		//입력하기 상세 - 취합문서 해당없음 처리
		InputingManager manager = InputingManager.instance();
		int retCode = manager.inputingNotApplicable(sysdocno, user_id, dept_code);
