...
public class OutsideReqDelAction extends Action{
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		try{
			...
			int reqformno = Integer.parseInt(nexti.ejms.agent.AgentUtil.decryptSeed(request.getParameter("reqformno")));
			
			//삭제
			OutsideManager manager = OutsideManager.instance();
			cnt = manager.RequestDel(reqformno, getServlet().getServletContext());
