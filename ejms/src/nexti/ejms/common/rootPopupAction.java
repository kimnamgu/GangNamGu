...
public abstract class rootPopupAction extends Action  {
	//팝업 화면의 부모 클래스로 쓸것
	private static Logger logger = Logger.getLogger(rootPopupAction.class);
	...
	public ActionForward execute(
		...
		if((session == null) || (session.getAttribute("user_id") == null)){
			...
			out.write("<script language=javascript>try {window.close(); opener.location.href='/';} catch(e) {window.dialogArguments.location.href='/';}</script>");
			out.close();
			return null;
		} else {		
