...
<script type="text/javascript">
		...
		$(document).ready(function(){
			...
			{	
				document.location.href = "/sosong/body.do";
			}
...
<br>
<img src="/sosong/images/main/main_title.jpg">
  ...
  <tr>
    <td class="pupup_frame" style="padding-right:12px">
		...
		<table border="0" cellspacing="0" cellpadding="0" class="btn" id="tblAddMemoTempSave21" style="filter:none;">
	     <tr>
	        <td><!-- <img src="/sosong/images/main/main_logo.jpg"> --></td>
	        <td width="30">&nbsp;</td>	        
	      </tr>
	     </table>
              ...
              <tr>
                ...
                <table border="0" cellspacing="0" cellpadding="0" class="btn" id="tblAddMemo21" style="filter:none;">
                  <tr>
                    ...
                    <td background="/sosong/images/btn_type0_bg.gif" class="btn_type1" nowrap><a href="#this" class="btn" id="login"><font color="white">로그인</font></a></td>
