...
<script type="text/javascript">
	    ...
	    function fn_initial_setting(){
			...
			$("#IMPORTANT_GB").val("${map.IMPORTANT_GB}");
			$("#DIRECT_GB").val("${map.DIRECT_GB}");
			$("#DONE_YN").val("${map.DONE_YN}");
			$("#WIN_LOSE_GB").val("${map.WIN_LOSE_GB}");
			
			if($("#DIRECT_GB option:selected").val() == "1")
				$("#LAWYER_GB option:eq(7)").attr("selected", "selected");
			else{
				if($("#CHRG_LAWYER").val() != "" || $("#CHRG_LAWYER").val() != null )			
					$("#LAWYER_GB").val($("#CHRG_LAWYER").val());
				else
					$("#LAWYER_GB option:eq(0)").attr("selected", "selected");
			}
			$("#CHRG_LAWYER").attr("readonly", true);
			$("#ICDNT_NO").attr("readonly", true);
			...
			if (tri_no == "11"){ //1심
				...
				appeal_html = "<input type=\"text\" id=\"APPEAL_RESPONSE_DATE\" name=\"APPEAL_RESPONSE_DATE\" value=\"" + fn_setting_date("${map.APPEAL_RESPONSE_DATE}") + "\" class=\"input\" style=\"width:100;\"> <a href=\"#a\" onclick=\"popUpCalendar(this, APPEAL_RESPONSE_DATE, 'yyyy-mm-dd');\"><img class=\"Lbtn\" src=\"/sosong/images/ic_cal.gif\" alt=\"달력\" /></a>";
				$("#APPEAL_HTML").html(appeal_html);
				
				var tmp_date = "${map.ARGUE_SET_DATE}";
				var strArray = tmp_date.split(';');				
				var argue_html = "";
				for(var i in strArray)
				{				   		   
					argue_html +=  (Number(i)+1) + "차  <input type=\"text\" id=\"ARGUE_SET" + (Number(i)+1) + "_DATE\" name=\"ARGUE_SET" + (Number(i)+1) + "_DATE\" value=\"" + fn_setting_date(strArray[i]) + "\" class=\"input\" style=\"width:100;\"> <a href=\"#a\" onclick=\"popUpCalendar(this, ARGUE_SET" + (Number(i)+1) + "_DATE, 'yyyy-mm-dd');\"><img class=\"Lbtn\" src=\"/sosong/images/ic_cal.gif\" alt=\"달력\" /></a><br>";					
				}
				d_cnt = (Number(i)+2);
				...
				submit_html = "<input type=\"text\" id=\"APPEAL_SUBMIT_DATE\" name=\"APPEAL_SUBMIT_DATE\" value=\"" + fn_setting_date("${map.APPEAL_SUBMIT_DATE}") + "\" class=\"input\" style=\"width:100;\"> <a href=\"#a\" onclick=\"popUpCalendar(this, APPEAL_SUBMIT_DATE, 'yyyy-mm-dd');\"><img class=\"Lbtn\" src=\"/sosong/images/ic_cal.gif\" alt=\"달력\" /></a>";				
				...
				//argue_html = "<input type=\"text\" id=\"ARGUE_SET1_DATE\" name=\"ARGUE_SET1_DATE\" value=\"" + fn_setting_date("${map.ARGUE_SET_DATE}") + "\" class=\"input\" style=\"width:100;\"> <a href=\"#a\" onclick=\"popUpCalendar(this, ARGUE_SET1_DATE, 'yyyy-mm-dd');\"><img class=\"Lbtn\" src=\"/sosong/images/ic_cal.gif\" alt=\"달력\" /></a>";
				$("#ARGUE_HTML").html(argue_html);
				...
				appeal_html = "<input type=\"text\" id=\"APPEAL_RESPONSE_DATE\" name=\"APPEAL_RESPONSE_DATE\" value=\"" + fn_setting_date("${map.APPEAL_RESPONSE_DATE}") + "\" class=\"input\" style=\"width:100;\"> <a href=\"#a\" onclick=\"popUpCalendar(this, APPEAL_RESPONSE_DATE, 'yyyy-mm-dd');\"><img class=\"Lbtn\" src=\"/sosong/images/ic_cal.gif\" alt=\"달력\" /></a> &nbsp;/<br>" +
							  "<input type=\"text\" id=\"APPEAL_REASON_DATE\" name=\"APPEAL_REASON_DATE\" value=\"" + fn_setting_date("${map.APPEAL_REASON_DATE}") + "\" class=\"input\" style=\"width:100;\"> <a href=\"#a\" onclick=\"popUpCalendar(this, APPEAL_REASON_DATE, 'yyyy-mm-dd');\"><img class=\"Lbtn\" src=\"/sosong/images/ic_cal.gif\" alt=\"달력\" /></a>";
			...
			$("#JUDGE_CONT_GB").val("${map.JUDGE_CONT_GB}");
			
		}
		
	    function fn_setting_date(date){
	    	var tmp = "";
	    	if(date.length == 8)
	    	{
	    		tmp = date.substring(0, 4)+ "-" + date.substring(4, 6) + "-" + date.substring(6, 8);
	    	}
	    	else
	    		tmp = date;
		...
		function fn_updateIndTrial(){			
			...
			if(confirm('데이터를 수정하시겠습니까?'))
			{
				...
				var argue_set_date = $("#ARGUE_SET1_DATE").val();
...
<input type="hidden" id="PERFORM_USERID" name="PERFORM_USERID" value="${map.PERFORM_USERID}">
<input type="hidden" id="PERFORM_USERHNO" name="PERFORM_USERHNO" value="${map.PERFORM_USERHNO}">
	      ...
	      <table width="100%" border="0" cellspacing="1" cellpadding="0" class="tbl" id="divMemoMainBody" style="display:block;">
	          ...
	          <tr>
	           ...
	           <tr>
	            ...
	            <td width="243" class="tbl_list_left">
	            	<input type="text" id="ICDNT_NO" name="ICDNT_NO" value="${map.ICDNT_NO}" class="input" style="width:200;">
	            </td>
	          ...
	          <tr>
	            ...
	            <td width="243" class="tbl_list_left">
	            	<input type="text" id="PERFORM_PERSON" name="PERFORM_PERSON" value="${map.PERFORM_PERSON}" class="input" style="width:200;"> 
	            ...
	            <td width="244" class="tbl_list_left">	            
	                ...
	                </select> <p><input type="text" id="CHRG_LAWYER" name="CHRG_LAWYER" value="${map.CHRG_LAWYER}" class="input" style="width:150;"></p>
				</td>
	          </tr>
	          <tr>
	          ...
	          <tr>
	            ...
	            <td width="243" class="tbl_list_left"><input type="text" id="SUE_DATE" name="SUE_DATE" value="<fmt:parseDate value="${map.SUE_DATE}" var="dateFmt1" pattern="yyyyMMdd"/><fmt:formatDate value="${dateFmt1}" pattern="yyyy-MM-dd"/>" class="input" style="width:100;"> <a href="#a" onclick="popUpCalendar(this, SUE_DATE, 'yyyy-mm-dd');"><img class="Lbtn" src="/sosong/images/ic_cal.gif" alt="달력" /></a></td>
				<td width="120" class="tbl_field">접수일자</td>
	            <td width="244" class="tbl_list_left"><input type="text" id="ACCEPT_DATE" name="ACCEPT_DATE" value="<fmt:parseDate value="${map.ACCEPT_DATE}" var="dateFmt1" pattern="yyyyMMdd"/><fmt:formatDate value="${dateFmt1}" pattern="yyyy-MM-dd"/>" class="input" style="width:100;"> <a href="#a" onclick="popUpCalendar(this, ACCEPT_DATE, 'yyyy-mm-dd');"><img class="Lbtn" src="/sosong/images/ic_cal.gif" alt="달력" /></a></td>							
	          </tr>
	          ...
	          <tr>
	            ...
	            <td width="244" class="tbl_list_left"><input type="text" id="JUDGE_CONT_NOTES" name="JUDGE_CONT_NOTES" value="${map.JUDGE_CONT_NOTES}" class="input" style="width:200;"></td>							
	          </tr>			 	
			  <tr>
	            <td width="120" class="tbl_field">판결일자</td>
	            <td width="243" class="tbl_list_left"><input type="text" id="JUDGE_DATE" name="JUDGE_DATE" value="<fmt:parseDate value="${map.JUDGE_DATE}" var="dateFmt1" pattern="yyyyMMdd"/><fmt:formatDate value="${dateFmt1}" pattern="yyyy-MM-dd"/>" class="input" style="width:100;"> <a href="#a" onclick="popUpCalendar(this, JUDGE_DATE, 'yyyy-mm-dd');"><img class="Lbtn" src="/sosong/images/ic_cal.gif" alt="달력" /></a></td>
				<td width="120" class="tbl_field">접수일자</td>
	            <td width="244" class="tbl_list_left"><input type="text" id="JG_ACCPT_DATE" name="JG_ACCPT_DATE" value="<fmt:parseDate value="${map.JG_ACCPT_DATE}" var="dateFmt1" pattern="yyyyMMdd"/><fmt:formatDate value="${dateFmt1}" pattern="yyyy-MM-dd"/>" class="input" style="width:100;"> <a href="#a" onclick="popUpCalendar(this, JG_ACCPT_DATE, 'yyyy-mm-dd');"><img class="Lbtn" src="/sosong/images/ic_cal.gif" alt="달력" /></a></td>	            						
	          </tr>
	          <tr>
	            <td width="120" class="tbl_field">착수금</td>
	            <td width="243" class="tbl_list_left"><input type="text" id="DEPOSIT_AMT" name="DEPOSIT_AMT" value="${map.DEPOSIT_AMT}" class="input" style="width:100;"></td>
				<td width="120" class="tbl_field">착수금 지급일자</td>
	            <td width="244" class="tbl_list_left"><input type="text" id="DEPOSIT_PAY_DATE" name="DEPOSIT_PAY_DATE" value="<fmt:parseDate value="${map.DEPOSIT_PAY_DATE}" var="dateFmt1" pattern="yyyyMMdd"/><fmt:formatDate value="${dateFmt1}" pattern="yyyy-MM-dd"/>" class="input" style="width:100;"> <a href="#a" onclick="popUpCalendar(this, DEPOSIT_PAY_DATE, 'yyyy-mm-dd');"><img class="Lbtn" src="/sosong/images/ic_cal.gif" alt="달력" /></a></td>	            						
	          </tr>
	          <tr>
	            <td width="120" class="tbl_field">사례금</td>
	            <td width="243" class="tbl_list_left"><input type="text" id="REWARD_AMT" name="REWARD_AMT" value="${map.REWARD_AMT}" class="input" style="width:100;"></td>
				<td width="120" class="tbl_field">사례금 지급일자</td>
	            <td width="244" class="tbl_list_left"><input type="text" id="REWARD_PAY_DATE" name="REWARD_PAY_DATE" value="<fmt:parseDate value="${map.REWARD_PAY_DATE}" var="dateFmt1" pattern="yyyyMMdd"/><fmt:formatDate value="${dateFmt1}" pattern="yyyy-MM-dd"/>" class="input" style="width:100;"> <a href="#a" onclick="popUpCalendar(this, REWARD_PAY_DATE, 'yyyy-mm-dd');"><img class="Lbtn" src="/sosong/images/ic_cal.gif" alt="달력" /></a></td>	            						
	          </tr>
	          <tr>
	            <td width="120" class="tbl_field">인지대</td>
	            <td width="243" class="tbl_list_left"><input type="text" id="STAMP_AMT" name="STAMP_AMT" value="${map.STAMP_AMT}" class="input" style="width:100;"></td>
				<td width="120" class="tbl_field">지급일자</td>
	            <td width="244" class="tbl_list_left"><input type="text" id="STAMP_PAY_DATE" name="STAMP_PAY_DATE" value="<fmt:parseDate value="${map.STAMP_PAY_DATE}" var="dateFmt1" pattern="yyyyMMdd"/><fmt:formatDate value="${dateFmt1}" pattern="yyyy-MM-dd"/>" class="input" style="width:100;"> <a href="#a" onclick="popUpCalendar(this, STAMP_PAY_DATE, 'yyyy-mm-dd');"><img class="Lbtn" src="/sosong/images/ic_cal.gif" alt="달력" /></a></td>	            						
	          </tr>
	          <tr>
	            <td width="120" class="tbl_field">송달료</td>
	            <td width="243" class="tbl_list_left"><input type="text" id="TRANSMIT_FEE" name="TRANSMIT_FEE" value="${map.TRANSMIT_FEE}" class="input" style="width:100;"></td>
				<td width="120" class="tbl_field">지급일자</td>
	            <td width="244" class="tbl_list_left"><input type="text" id="TRANSMIT_PAY_DATE" name="TRANSMIT_PAY_DATE" value="<fmt:parseDate value="${map.TRANSMIT_PAY_DATE}" var="dateFmt1" pattern="yyyyMMdd"/><fmt:formatDate value="${dateFmt1}" pattern="yyyy-MM-dd"/>" class="input" style="width:100;"> <a href="#a" onclick="popUpCalendar(this, TRANSMIT_PAY_DATE, 'yyyy-mm-dd');"><img class="Lbtn" src="/sosong/images/ic_cal.gif" alt="달력" /></a></td>	            						
	          </tr>	          
	         <tr>
	            <td width="120" class="tbl_field">기타</td>
	            <td width="243" class="tbl_list_left"><input type="text" id="ETC1" name="ETC1" value="${map.ETC1}" class="input" style="width:240;"></td>
				<td width="120" class="tbl_field"></td>
	            <td width="244" class="tbl_list_left"></td>	            						
	          </tr>	   
	      </table>
