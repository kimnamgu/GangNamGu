        ...
        <!--리스트 시작 -->
	      <table width="100%" border="0" cellspacing="1" cellpadding="0" class="tbl" id="divMemoMainBody" style="display:block;">	          
	          <tr>
	            ...
	            <td width="244" class="tbl_list_left"><input type="text" id="ICDNT_NO" name="ICDNT_NO" class="input" style="width:200;"></td>							
	          </tr>         
	          <tr>
	            ...
	            <td width="244" class="tbl_list_left"><input type="text" id="JUDGE_DATE" name="JUDGE_DATE" class="input" style="width:100;"> <a href="#a" onclick="popUpCalendar(this, JUDGE_DATE, 'yyyy-mm-dd');"><img class="Lbtn" src="/sosong/images/ic_cal.gif" alt="달력" /></a></td>							
	          </tr>			  
	          <tr>
	            <td width="120" class="tbl_field">비용회수내역</td>
	            <td width="243" class="tbl_list_left"><input type="text" id="ETC1" name="ETC1" class="input" style="width:200;"></td>
				<td width="120" class="tbl_field">비고</td>
	            <td width="244" class="tbl_list_left"><input type="text" id="ETC2" name="ETC2" class="input" style="width:200;"></td>	            						
	          </tr>	                 
	      </table>
