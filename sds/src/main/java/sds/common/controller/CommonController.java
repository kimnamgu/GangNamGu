...
import sds.common.util.AES256Cipher;
import sds.common.util.AES256Util;
import sds.common.util.CookieUtils;

import sds.common.util.Base64Coder;
...
public class CommonController {
	...
	public void downloadFile(CommandMap commandMap, HttpServletResponse response, HttpServletRequest request) throws Exception{
		...
		{
			file_path = "/usr/local/server/file/sds/";
		}
		else
		{
