        ...
        <!--리스트 시작 -->
	      <table width="100%" border="0" cellspacing="1" cellpadding="0" class="tbl" id="divMemoMainBody" style="display:block;">
	          ...
	          <tr>
	            ...
	            <td width="607" colspan="3" class="tbl_list_left"><input type="text" id="SAUP_BUDGET_AMT" name="SAUP_BUDGET_AMT" class="input" style="width:300;"> 원</td>									
	          </tr>	         	         	          
	          <tr>
	          ...
	          <tr>
	            ...
	            <td width="607" colspan="3" class="tbl_list_left"><input type="text" id="ACCEPT_ST_DATE" name="ACCEPT_ST_DATE" value="" class="input" style="width:100;"> ~ <input type="text" id="ACCEPT_ED_DATE" name="ACCEPT_ED_DATE" value="" class="input" style="width:100;"><p><b>* 접수마감일은  주말, 공휴일 제외하고 접수시작일 포함 3일입니다.</b></p></td>									
	          </tr>	              	        
	          <tr>
