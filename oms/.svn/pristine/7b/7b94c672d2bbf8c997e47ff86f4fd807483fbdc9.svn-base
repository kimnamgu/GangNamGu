	      ...
	      <table width="100%" border="0" cellspacing="1" cellpadding="0" class="tbl" id="divMemoMainBody" style="display:block;">	         
			  <tr>
	            ...
	            <td colspan="3" width="607" class="tbl_list_left">
	                <input type="text" id="QD_ILJA" name="QD_ILJA" value="<fmt:parseDate value="${map.QD_ILJA}" var="dateFmt1" pattern="yyyyMMdd"/><fmt:formatDate value="${dateFmt1}" pattern="yyyy-MM-dd"/>" class="input" style="width:174;">                
	            </td>								
	          </tr>
			  <tr>
