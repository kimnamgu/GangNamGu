      ...
      <tr>
		...
		<tr>
			...
			<table border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td class="title"><img src="/oms/images/title_ico.gif" align="absmiddle">					
					<c:choose>
				    <c:when test="${bdId eq '1'}">
			                   자료실 등록
			    	</c:when>
        ...
        <!--리스트 시작 -->
	      <table width="100%" border="0" cellspacing="1" cellpadding="0" class="tbl" id="divMemoMainBody" style="display:block;">
			  ...
			  <tr>
	            ...
	            <td colspan="3" width="607" class="tbl_list_left">
	                <textarea rows="7" cols="76" id="CONTENTS" name="CONTENTS" class="input" style="width:700px;height:350px;" rows="4" cols="50"></textarea>
	              <!--script type="text/javascript">						 
	              var oEditors = [];
