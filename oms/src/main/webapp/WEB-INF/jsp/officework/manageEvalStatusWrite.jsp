...
<script type="text/javascript">
		...
		function fn_insertBoard(){
			...
			{
				comSubmit.setUrl("<c:url value='/officework/insertManageEvalStatus.do' />");
				comSubmit.addParam("WDID", $("#WRITE_DEPT").val());
				comSubmit.addParam("SAUP_DEPT", $('#SAUP_DEPT').val());
				comSubmit.submit();
			}
	      ...
	      <table width="100%" border="0" cellspacing="1" cellpadding="0" class="tbl" id="divMemoMainBody" style="display:block;">	         
			  <tr>
	            ...
	            <td colspan="3" width="607" class="tbl_list_left">
	                <input type="text" id="ME_ILJA" name="ME_ILJA" class="input" style="width:174;">                
	            </td>								
	          </tr>
			  <tr>
	            <td width="120" class="tbl_field">평가내용</td>
	            <td colspan="3" width="607" class="tbl_list_left">
	                <input type="text" id="ME_EVAL_CONTENTS" name="ME_EVAL_CONTENTS" class="input" style="width:557;">	                
	            </td>
	          </tr>
			  <tr>
	            <td width="120" class="tbl_field">평가결과</td>
	            <td colspan="3" width="607" class="tbl_list_left">
	                <input type="text" id="ME_EVAL_RESULT" name="ME_EVAL_RESULT" class="input" style="width:557;">	                
	            </td>
	          </tr>	         
	      </table>
