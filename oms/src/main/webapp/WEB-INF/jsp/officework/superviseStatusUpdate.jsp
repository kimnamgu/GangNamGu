...
<script type="text/javascript">
		...
		function fn_updateSuperviseStatus(){
			...
			{
				comSubmit.setUrl("<c:url value='/officework/updateSuperviseStatus.do' />");
		...
		function fn_deleteSuperviseStatus(){
			var comSubmit = new ComSubmit("form1");
			
			if(confirm('데이터를 삭제하시겠습니까?'))
			{
				comSubmit.setUrl("<c:url value='/officework/deleteSuperviseStatus.do' />");
				comSubmit.addParam("ID", "${map.ID}");
				comSubmit.addParam("OW_ID", "${map.OW_ID}");
				comSubmit.addParam("WDID", $("#WRITE_DEPT").val());
				comSubmit.addParam("SAUP_DEPT", $('#SAUP_DEPT').val());
	      ...
	      <table width="100%" border="0" cellspacing="1" cellpadding="0" class="tbl" id="divMemoMainBody" style="display:block;">	         
			  <tr>
	            ...
	            <td colspan="3" width="607" class="tbl_list_left">
	                <input type="text" id="SV_ILJA" name="SV_ILJA" value="<fmt:parseDate value="${map.SV_ILJA}" var="dateFmt1" pattern="yyyyMMdd"/><fmt:formatDate value="${dateFmt1}" pattern="yyyy-MM-dd"/>" class="input" style="width:174;">                
	            </td>								
	          </tr>
			  <tr>
	            <td width="120" class="tbl_field">지도감독자</td>
	            <td colspan="3" width="607" class="tbl_list_left">
	                <input type="text" id="SV_PERSON" name="SV_PERSON" value="${map.SV_PERSON}" class="input" style="width:557;">	                
	            </td>
	          </tr>
			  <tr>
	            <td width="120" class="tbl_field">지도감독내용</td>
	            <td colspan="3" width="607" class="tbl_list_left">
	                <input type="text" id="SV_CONTENTS" name="SV_CONTENTS" value="${map.SV_CONTENTS}" class="input" style="width:557;">	                
	            </td>
	          </tr>
	          <tr>
	            <td width="120" class="tbl_field">지적사항</td>
	            <td colspan="3" width="607" class="tbl_list_left">
	                <input type="text" id="SV_INDCATE_ITEM" name="SV_INDCATE_ITEM" value="${map.SV_INDCATE_ITEM}" class="input" style="width:557;">	                
	            </td>
	          </tr>
	          <tr>
	            <td width="120" class="tbl_field">조치결과</td>
	            <td colspan="3" width="607" class="tbl_list_left">
	                <input type="text" id="SV_ACTION_RESULT" name="SV_ACTION_RESULT" value="${map.SV_ACTION_RESULT}" class="input" style="width:557;">	                
	            </td>
	          </tr>
	      </table>
