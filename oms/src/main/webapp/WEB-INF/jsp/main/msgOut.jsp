...
<script type="text/javascript">
		...
		$(document).ready(function(){
			...
			if(flag == '1')
			{
				$("#msg").html('사용승인이 안되어 있습니다!!<br><br>관리자에게 연락하여 [사용승인] 받고 이용하시길 바랍니다.(☎ 5464)');
			}
			else if(flag == '2'){
				$("#msg").html('등록이 완료되었습니다.<br><br>관리자에게 연락하여 [사용승인] 받고  다시 접속하시길 바랍니다.(☎ 5464)');
			}
			else if(flag == '3'){
      ...
      <tr>
		...
		<tr>
			...
			<table border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td class="title"><img src="/oms/images/title_ico.gif" align="absmiddle">메세지</td>
				</tr>
			</table>
			</td>				
		</tr>
