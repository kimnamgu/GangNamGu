...
public class ExcelRead {
     public static List<Map<String, String>> read(int sno, ExcelReadOption excelReadOption) {
            //엑셀 파일 자체
            //엑셀파일을 읽어 들인다.
             ...
             */
            Sheet sheet = wb.getSheetAt(sno);
            
            System.out.println("Sheet 이름: "+ wb.getSheetName(sno)); 
            System.out.println("데이터가 있는 Sheet의 수 :" + wb.getNumberOfSheets());
            /**
             * sheet에서 유효한(데이터가 있는) 행의 개수를 가져온다.
             */
            int numOfRows = sheet.getPhysicalNumberOfRows();
            System.out.println("line num = [" + numOfRows + "]");
            int numOfCells = 0;
            ...
            for(int rowIndex = excelReadOption.getStartRow() - 1; rowIndex < numOfRows; rowIndex++) {
                ...
                if(row != null) {
                    ...
                    for(int cellIndex = 0; cellIndex < numOfCells; cellIndex++) {
                        ...
                        System.out.println("rowIndex cell === [" + rowIndex + "][" + cellIndex + "]" );
