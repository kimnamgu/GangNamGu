package ffems.common.controller;
...
import ffems.common.service.CommonService;
import ffems.common.util.Nvl;
...
public class CommonController {
	...
	public ModelAndView ssoLogin(CommandMap commandMap, HttpServletRequest request, RedirectAttributes redirecAttributes) throws Exception{
		...
		ModelAndView mv = new ModelAndView("redirect:/mbody.do");		
		String deStrId = null;
