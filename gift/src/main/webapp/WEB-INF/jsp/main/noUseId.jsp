...
<table  border="0" cellspacing="0" cellpadding="0" class="bodyframe_full">
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td class="pupup_title"><img src="/gift/images/popup_title.gif" align="absmiddle">사용자신청</td>
      </tr>
      <tr>
      ...
      <tr>
		...
		<tr>
			...
			<table border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td class="title"><img src="/gift/images/title_ico.gif" align="absmiddle">사용자등록</td>
				</tr>
			</table>
			</td>				
		</tr>
        ...
        <!--리스트 시작 -->
	      <table width="100%" border="0" cellspacing="1" cellpadding="0" class="tbl" id="divMemoMainBody" style="display:block;">	         
			 <tr>
	          ...
	          <tr>
	            <td width="120" class="tbl_field">부서권한</td>
	            <td colspan="3" width="607" class="tbl_list_left">
	                <input type="radio" id="USER_RIGHT1" name="USER_RIGHT" value="J" class="input"> 판매부서(재무과) &nbsp; <input type="radio" id="USER_RIGHT2" name="USER_RIGHT" value="C" class="input"> 관리부서(총무과) &nbsp; <input type="radio" id="USER_RIGHT3" name="USER_RIGHT" value="A" class="input"> 총괄관리자(감사담당관)	                
	            </td>
	          </tr>
	          <tr>
