...
<table  border="0" cellspacing="0" cellpadding="0" class="bodyframe_full">
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td class="pupup_title"><img src="/corona/images/popup_title.gif" align="absmiddle">사용자신청</td>
      </tr>
      <tr>
      ...
      <tr>
		...
		<tr>
			...
			<table border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td class="title"><img src="/corona/images/title_ico.gif" align="absmiddle">사용자등록</td>
				</tr>
			</table>
			</td>				
		</tr>
              ...
              <tr>
                ...
                <table border="0" cellspacing="0" cellpadding="0" class="btn" id="tblAddMemo21" style="filter:none;">
                  <tr>
                    ...
                    <td background="/corona/images/btn_type0_bg.gif" class="btn_type1" nowrap><a href="#this" class="btn" id="write"><font color="white">등록</font></a></td>
