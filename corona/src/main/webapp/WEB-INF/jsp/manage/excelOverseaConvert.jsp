...
<%
	...
	String fileName="overseaRecord_" + day;
...
<tbody>
			...
			<c:forEach var="resultlist" items="${resultlist}">
				<tr>
					...
					<td style="text-align:left;">${resultlist.COME_DATE} </td>
					<td style="text-align:left;">${resultlist.FREE_DATE} </td>
					<td style="text-align:left;">${resultlist.VISIT_NATION} </td>
