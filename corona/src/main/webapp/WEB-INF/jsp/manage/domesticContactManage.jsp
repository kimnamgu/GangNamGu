...
<script type="text/javascript">
    ...
    function delChkRow() {
		...
		if (confirm("선택 항목을 삭제 하시겠습니까?")) {
			...
			$.ajax({
		        type: "post",
		        url : "/corona/manage/deleteDomesticChk.do",
		        data: {
		        	val:checkedValue
		        },
...
<div style="width:100%;padding-left:20px;padding-right:10px;">
	...
	<div style="float:left;margin-left:10px;margin-bottom:10px;">
		...
		<form id="excelDown" name="excelDown" method="post" enctype="multipart/form-data">
			...
			<input type="image" src="/corona/images/common/btn_excel.gif" style="border:0;" onclick="doExcelDownloadProcess('/corona/manage/downloadDomesticExcelFile.do')" alt="엑셀다운로드">
		</form>
	</div>

	<!-- 샘플다운로드 -->
	<div style="float:left;margin-left:10px;margin-bottom:10px;">
		<input class="btn btn-info btn-sm" type="button" id="sample_download" onClick="fn_sampleDownload('domestic')" value="엑셀샘플"> 
	</div>


<div class="contents" style="float:right;margin-right:22px;">
	<a href="/corona/write/domesticWrite.do" class="btn btn-primary btn-sm" id="insert">입력</a>
...
<div class="contents" style="float:right;">
	...
	<form id="excelUploadForm" name="excelUploadForm" enctype="multipart/form-data" method="post" action="/corona/manage/domesticContactExcelUp.do">
