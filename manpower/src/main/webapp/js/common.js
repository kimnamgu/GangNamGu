...
function gfn_renderPaging(params){
	...
	if(totalIndexCount > 10){ //전체 인덱스가 10이 넘을 경우, 맨앞, 앞 태그 작성
		preStr += "<a href='#this' class='pad_5' onclick='_movePage(1,\"" + gfv_eventName + "\", \"" + gfv_pageIndex + "\")'>[<<]</a> " +
				"<a href='#this' class='pad_5' onclick='_movePage("+prev+", \"" + gfv_eventName +  "\", \"" + gfv_pageIndex + "\")'>[<]</a> ";
	}
	...
	if(totalIndexCount > 10){ //전체 인덱스가 10이 넘을 경우, 맨뒤, 뒤 태그 작성
		postStr += "<a href='#this' class='pad_5' onclick='_movePage("+next+", \"" + gfv_eventName +  "\" )'>[>]</a>" +
					"<a href='#this' class='pad_5' onclick='_movePage("+totalIndexCount+ ", \"" + gfv_eventName +  "\", \"" + gfv_pageIndex + "\")'>[>>]</a> ";
	}
	else if(totalIndexCount <=10 && totalIndexCount > 1){ //전체 인덱스가 10보다 작을경우, 맨뒤 태그 작성
		postStr += "<a href='#this' class='pad_5' onclick='_movePage("+totalIndexCount+", \"" + gfv_eventName + "\", \"" + gfv_pageIndex + "\")'>[>>]</a> ";
	}
	
	for(var i=first; i<(first+last); i++){
		if(i != currentIndex){
			str += " <a href='#this' class='pad_5' onclick='_movePage("+i+", \"" + gfv_eventName + "\", \"" + gfv_pageIndex + "\")'>"+i+"</a> ";
		}
		else{
			str += " <strong><a href='#this' class='pad_5' onclick='_movePage("+i+",\"" + gfv_eventName + "\", \"" + gfv_pageIndex + "\")'>"+i+"</a></strong> ";
		}
	}
...
function _movePage(value, evt_nm, pidx){
	//alert( pidx);
	$("#"+pidx).val(value);
	if(typeof(gfv_eventName) == "function"){
		//alert('mv i: [' + evt_nm + '] [' + value + ']');
		evt_nm(value);
	}
	else {
		//alert('mv e: [' + evt_nm + '] [' + value + ']');
		eval(evt_nm + "(value);");
	}
}
