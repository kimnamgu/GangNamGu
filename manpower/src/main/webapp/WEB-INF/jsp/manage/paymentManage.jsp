...
<div style="width:100%;padding-left:20px;padding-right:10px;">
		...
		<form action="" method="post">
			<div class="card-body card-block">
				<div>
					...
					<div class="form-group" style="width: 360;float:left;margin-left:5px;">
						<div class="input-group">
							<div class="input-group-addon" style="width: 80px;">주소</div>
							<input type="text" id="NAME" name="NAME" value="" class="form-control">
						</div>
					</div>
					...
					<div class="form-group" style="width: 360;float:left;margin-left:5px;">
						<div class="input-group">
							<div class="input-group-addon" style="width: 80px;">휴대폰</div>
							<input type="text" id="NAME" name="NAME" value="" class="form-control">
						</div>
					</div>
					...
					<div class="form-group" style="width: 360;float:left;margin-left:5px;">
						<div class="input-group">
							<div class="input-group-addon" style="width: 80px;">년월</div>
							<input type="text" id="NAME" name="NAME" value="" class="form-control">
						</div>
					</div>
					...
					<div class="form-group" style="width: 360;float:left;margin-left:5px;">
						<div class="input-group">
							<div class="input-group-addon" style="width: 80px;">기타</div>
							<input type="text" id="NAME" name="NAME" value="" class="form-control">
						</div>
					</div>
	...
	<!-- 샘플다운로드 -->
	<div style="float:left;margin-left:10px;margin-bottom:10px;">
		<input class="btn btn-info btn-sm" type="button" id="sample_download" onClick="fn_sampleDownload('domestic')" value="급여명세서">
		<input class="btn btn-info btn-sm" type="button" id="sample_download" onClick="fn_sampleDownload('domestic')" value="입금의뢰서"> 
	</div>

<div class="contents" style="float:right;margin-right:22px;margin-bottom:10px;">
	<a href="/manpower/write/paymentWrite.do" class="btn btn-primary btn-sm" id="insert">등록</a>
...
<div class="contents" style="float:right;">
	...
	<form id="excelUploadForm" name="excelUploadForm" enctype="multipart/form-data" method="post" action="/manpower/manage/paymentExcelUp.do">
