...
<div style="width:100%;padding-left:20px;padding-right:10px;">
	...
	<!-- 샘플다운로드 -->
	<div style="float:left;margin-left:10px;margin-bottom:10px;">
		<input class="btn btn-info btn-sm" type="button" id="sample_download" onClick="fn_sampleDownload('domestic')" value="일괄처리(종료)">
		<input class="btn btn-info btn-sm" type="button" id="sample_download" onClick="fn_sampleDownload('domestic')" value="일괄처리(진행)"> 
	</div>

<div class="contents" style="float:right;margin-right:22px;margin-bottom:10px;">
	<a href="/manpower/write/businessWrite.do" class="btn btn-primary btn-sm" id="insert">등록</a>
...
<div class="contents" style="float:right;">
	...
	<form id="excelUploadForm" name="excelUploadForm" enctype="multipart/form-data" method="post" action="/manpower/manage/domesticContactExcelUp.do">
