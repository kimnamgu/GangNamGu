...
import manpower.common.util.CommonLib;
...
public class Nvl {
    ...
    //str占쏙옙 int占쏙옙占쏙옙占쏙옙 占쏙옙환占쏙옙 占쏙옙占쏙옙(str占쏙옙 null占싱몌옙 0占쏙옙占쏙옙)
    public static int nvlInt(String str) {
        if(CommonLib.isBlank(str)) return 0;
        else return Integer.parseInt(str);
    }
    //str占쏙옙 int占쏙옙占쏙옙占쏙옙 占쏙옙환占쏙옙 占쏙옙占쏙옙(str占쏙옙 null占싱몌옙 defaultInt占쏙옙占쏙옙)
    ...
    //str占썼열占쏙옙 int占쏙옙占쏙옙占쏙옙 占쏙옙占쏙옙 占쏙옙환占쏙옙 占쏙옙占쏙옙
    public static int[] nvlInt(String[] str) {
