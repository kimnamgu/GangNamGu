...
public class DaejangDAO extends AbstractDAO{
	...
	public Map<String, Object> getDocIssueReserveRecent(Map<String, Object> map) throws Exception{
		
		Map<String, Object> rtmap = new HashMap<>();
		
		rtmap = (Map<String, Object>) selectOne("daejang.getDocIssueReserveRecent", map);
		log.debug("log DaejangDao rtn==> [" + rtmap + "]");
		return rtmap;
	}
	...
	@SuppressWarnings("unchecked")
	public List<Map<String, Object>> selectSeosonList() throws Exception{
		return (List<Map<String, Object>>)selectList("daejang.selectSeosonList");
	}
	...
	@SuppressWarnings("unchecked")
	public Map<String, Object> getDocumentKindInfo(Map<String, Object> map) throws Exception{
		return (Map<String, Object>) selectOne("daejang.getDocumentKindInfo", map);
	}
}
