package service.common.service;
...
public interface CommonService {
	...
	void insertSmsLog(Map<String, Object> map) throws Exception;
	
	List<Map<String, Object>> SelectSmsUserList(Map<String, Object> map) throws Exception;
}
