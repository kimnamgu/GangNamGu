...
public class CommonDAO extends AbstractDAO{
	...
	public void sendSms(Map<String, Object> map) throws Exception{
		System.out.println("sendSms map 확인 : " + map.toString());
		insertMysql("sms.sendSms", map);
	}
	
	public void insertSmsLog(Map<String, Object> map) throws Exception{
		System.out.println("insertSmsLog map 확인 : " + map.toString());
		insert("common.insertSmsLog", map);
	}
	
	@SuppressWarnings("unchecked")
	public List<Map<String, Object>> SelectSmsUserList(Map<String, Object> map) throws Exception{
		
		return (List<Map<String, Object>>)selectList("common.SelectSmsUserList", map);
	}
