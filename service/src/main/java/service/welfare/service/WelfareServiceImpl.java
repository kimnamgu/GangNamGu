...
public class WelfareServiceImpl implements WelfareService {
	...
	public Map<String, Object> updateDocIssueReserve(Map<String, Object> map, HttpServletRequest request) throws Exception{
		System.out.println("updateDocIssueReserve 오나");
	...
	// 정보 업데이트
	@Override
	public Map<String, Object> updateWelfareInfo(Map<String, Object> map, HttpServletRequest request) throws Exception{
		System.out.println("updateWelfareInfo 오나");
		log.debug("테스트 map :: " + map.toString());
		Map<String, Object> rtmap = new HashMap<>();
		
		rtmap = welfareDAO.updateWelfareInfo(map);
		return rtmap;
	}
	
	@Override
	public List<Map<String, Object>> welfarUserSelectList(Map<String, Object> map) throws Exception {
		return welfareDAO.welfarUserSelectList(map);
	}
	
	
	@Override
	public List<Map<String, Object>> welfareSelectCt(Map<String, Object> map) throws Exception {
		return welfareDAO.welfareSelectCt(map);
	}
