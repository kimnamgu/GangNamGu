...
public class DaejangController {
	...
	@RequestMapping(value="/daejang/deleteFixedDateData.do")
	public ModelAndView deleteFixedDateData(CommandMap commandMap, HttpServletRequest request) throws Exception{
		ModelAndView mv = new ModelAndView("redirect:/daejang/fixedDateList.do");
		
		daejangService.deleteFixedDateData(commandMap.getMap(), request);	
