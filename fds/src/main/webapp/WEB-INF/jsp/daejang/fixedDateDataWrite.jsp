...
<script type="text/javascript">
		...
		function fn_insertFixedDateData(){
			...
			{
				comSubmit.setUrl("<c:url value='/daejang/insertFixedDateData.do' />");
				comSubmit.submit();
			}
		}
...
<table  border="0" cellspacing="0" cellpadding="0" class="bodyframe_full">
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td class="pupup_title"><img src="/fds/images/popup_title.gif" align="absmiddle">확정일자 데이터 등록</td>
      </tr>
      <tr>
    ...
    <!--페이지 타이틀 끝 -->
	 ...
	 <tr>
		...
		<table border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td class="title"><img src="/fds/images/title_ico.gif" align="absmiddle">데이터 추가</td>
			</tr>
		</table>
		</td>				
	</tr>
	      ...
	      <table width="100%" border="0" cellspacing="1" cellpadding="0" class="tbl" id="divMemoMainBody" style="display:block;">
	          <tr>
	            ...
	            <td width="500" class="tbl_list_left">
	                <input type="text" id="TENANT_NAME" name="TENANT_NAME" class="input" style="width:174;">	                
	            </td>
	          </tr>
	          ...
	          <tr>
	            ...
	            <td width="500" class="tbl_list_left">	                
	                <input type="text" id="FIXDATE_GRANT_DATE" name="FIXDATE_GRANT_DATE" class="input" style="width:174;">	<a href="#a" onclick="popUpCalendar(this, FIXDATE_GRANT_DATE, 'yyyy-mm-dd');"><img class="Lbtn" src="/fds/images/ic_cal.gif" alt="달력" /></a>	                
	            </td>
	          </tr>
	          <tr>
	            ...
	            <td width="500" class="tbl_list_left">
	                ...
	                <div id="fileDiv">
						<p>
							<input twidth="350" type="file" id="file" name="file_0">
	          ...
	          <tr>
	            ...
	            <td width="500" class="tbl_list_left">
	                <input type="text" id="BIGO" name="BIGO" class="input" style="width:230;">
	            </td>							
	          </tr>			  	 
	      </table>
              ...
              <tr>
                ...
                <table border="0" cellspacing="0" cellpadding="0" class="btn" id="tblAddMemo21" style="filter:none;">
                  <tr>
                    ...
                    <td background="/fds/images/btn_type0_bg.gif" class="btn_type1" nowrap><a href="#this" class="btn" id="write"><font color="white">등록</font></a></td>
