...
<script type="text/javascript">
		...
		function fn_initial_setting(){
			...
			if("${map.GN_GB}" == "1")
				$("input:checkbox[id='C_GN_GB']").prop("checked", true);
			
			$('input:radio[name=INCDNT_GB]:input[value=' + "${map.INCDNT_GB}" + ']').attr("checked", true);
			$("#WIN_LOSE_GB").val("${map.WIN_LOSE_GB}");
			$("#LAST_SIM_GB").val("${map.LAST_SIM_GB}");
		...
		function fn_updateIncidentBasic(){
			...
			{							
				comSubmit.setUrl("<c:url value='/incident/updateIncidentBasic.do' />");
        ...
        <!--리스트 시작 -->
	      <table width="100%" border="0" cellspacing="1" cellpadding="0" class="tbl" id="divMemoMainBody" style="display:block;">
	          <tr>
	            ...
	            <td width="244" class="tbl_list_left"><input type="text" id="INCDNT_NAME" name="INCDNT_NAME" value="${map.INCDNT_NAME}" class="input" style="width:200;"></td>							
	          </tr>
	          <tr>
	            <td width="120" class="tbl_field">원고</td>
	            <td width="243" class="tbl_list_left">구소제기  <input type="checkbox" id="C_GN_GB" name="C_GN_GB" class="input"> <input type="text" id="CMPLN_NAME" name="CMPLN_NAME" value="${map.CMPLN_NAME}" class="input" style="width:200;"></td>
				<td width="120" class="tbl_field">특이사항</td>
	            <td width="244" class="tbl_list_left"><input type="text" id="NOTE" name="NOTE" value="${map.NOTE}" class="input" style="width:200;"></td>							
	          </tr>
	          <tr>
	            <td width="120" class="tbl_field">피고</td>
	            <td width="243" class="tbl_list_left"><input type="text" id="DFNDNT_NAME" name="DFNDNT_NAME" value="${map.DFNDNT_NAME}" class="input" style="width:200;"></td>
				<td width="120" class="tbl_field">소관부서</td>
	            <td width="244" class="tbl_list_left">
	                <select id="I_DEPT_CD" name="I_DEPT_CD" class="input" size="10" multiple="multiple">	                		                    		               
	                </select>
				</td>							
	          </tr>			 	
			  <tr>
	            <td width="120" class="tbl_field">소가</td>
	            <td width="243" class="tbl_list_left"><input type="text" id="LAWSUIT_VALUE" name="LAWSUIT_VALUE" value="${map.LAWSUIT_VALUE}" class="input" style="width:200;"></td>
	          ...
	          <tr>
	            ...
	            <td width="243" class="tbl_list_left"><input type="text" id="BIGO" name="BIGO" value="${map.BIGO}" class="input" style="width:200;"></td>
