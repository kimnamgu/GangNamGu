...
<script type="text/javascript">
		...
		function fn_insertBoard(){
			...
			{
				comSubmit.setUrl("<c:url value='/officework/insertGuAssembAgreement.do' />");
				comSubmit.addParam("WDID", $("#WRITE_DEPT").val());
				comSubmit.addParam("SAUP_DEPT", $('#SAUP_DEPT').val());
				comSubmit.submit();
			}
	      ...
	      <table width="100%" border="0" cellspacing="1" cellpadding="0" class="tbl" id="divMemoMainBody" style="display:block;">	         
			  <tr>
	            ...
	            <td colspan="3" width="607" class="tbl_list_left">
	                <input type="text" id="GA_ILJA" name="GA_ILJA" class="input" style="width:174;">                
	            </td>								
	          </tr>
			  <tr>
	            <td width="120" class="tbl_field">결과</td>
	            <td colspan="3" width="607" class="tbl_list_left">
	                <input type="text" id="GA_RESULT" name="GA_RESULT" class="input" style="width:557;">	                
	            </td>
	          </tr>
			  <tr>
	            <td width="120" class="tbl_field">비고</td>
	            <td colspan="3" width="607" class="tbl_list_left">
	                <input type="text" id="GA_BIGO" name="GA_BIGO" class="input" style="width:557;">	                
	            </td>
	          </tr>	         
	      </table>
