...
<div id="dropdownNav">
	<ul id="nav">
		<li class="show">
			...
			<ul>
				<li><a href="/manpower/manage/noticeManage.do" target="main"><span>- </span> 공지사항</a></li>
				<li><a href="/manpower/manage/paymentManage.do" target="main"><span>- </span> 임금관리</a></li>
				<c:if test="${chkAdmin eq 'A'}">
					<li><a href="/manpower/manage/workerManage.do" target="main"><span>- </span> 인력관리</a></li>
					<li><a href="/manpower/manage/businessManage.do" target="main"><span>- </span> 사업관리</a></li>
					<li><a href="/manpower/manage/bankManage.do" target="main"><span>- </span> 은행코드관리</a></li>
					<li><a href="/manpower/manage/manpowerStatus.do" target="main"><span>- </span> 통계</a></li>
					<li><a href="/manpower/manage/authorityManage.do" target="main"><span>- </span> 권한관리</a></li>
					<li><a href="/manpower/manage/incomeManage.do" target="main"><span>- </span> 소득세 관리</a></li>
				</c:if>						
			</ul>
		</li>
	</ul>
