...
<script type="text/javascript">
		...
		$(document).ready(function(){
			...
			{	
				document.location.href = "/ffems/daejang/ffemsDataList.do";
			}
...
<table  border="0" cellspacing="0" cellpadding="0" class="bodyframe_full">
  <tr>
    ...
    <table width="620" border="0" cellspacing="1" cellpadding="0" class="tbl"> 
      <tr>
        <td class="pupup_title"><a href="#this" class="btn" id="logout"><img src="/ffems/images/popup_title.gif" align="absmiddle"></a>신속재정 관리시스템</td>
      </tr>
      <tr>
         ...
         <tr>   	           
           ...
           <table border="0" cellspacing="0" cellpadding="0" class="btn" id="changebtn2" style="display:block;">
             <tr>
               ...
               <td background="/ffems/images/btn_type0_bg.gif" class="btn_type1" nowrap><a href="#this" class="btn" id="login"><font color="white">로그인</font></a></td>
