...
<div class="card" style="width:700px;margin-left:20px;">
    <div class="card-header">
	    <div style="float:left;">
	        <strong>기간제 근로자 응시자 정보 상세조회</strong>
	    </div>
    ...
    <div class="card-body card-block">
            ...
            <div class="row form-group">
                <div class="col col-md-3">
                    <label for="text-input" class=" form-control-label">성별</label>
                </div>
                <div class="col-12 col-md-9">
                    <input type="text" id="text-input" name="text-input" class="form-control" value="${map.sex}" style="background-color:white!important;" readonly>
                </div>
            </div>
            <div class="row form-group">
                <div class="col col-md-3">
            ...
            <div class="row form-group">
                <div class="col col-md-3">
                    <label for="text-input" class=" form-control-label">국가유공자해당여부</label>
                </div>
                <div class="col-12 col-md-9">
                    <input type="text" id="text-input" name="text-input" class="form-control" value="${map.national_merit_yn}" style="background-color:white!important;" readonly>
                </div>
            </div>
            <div class="row form-group">
                <div class="col col-md-3">
                    <label for="text-input" class=" form-control-label">운전가능여부</label>
                </div>
                <div class="col-12 col-md-9">
                    <input type="text" id="text-input" name="text-input" class="form-control" value="${map.drive_yn}" style="background-color:white!important;" readonly>
                </div>
            </div>
            <div class="row form-group">
                <div class="col col-md-3">
                    <label for="text-input" class=" form-control-label">운전면허종류(종별)</label>
                </div>
                <div class="col-12 col-md-9">
                    <input type="text" id="text-input" name="text-input" class="form-control" value="${map.drive_class_jong}" style="background-color:white!important;" readonly>
                </div>
            </div>
            <div class="row form-group">
                <div class="col col-md-3">
                    <label for="text-input" class=" form-control-label">운전면허종류(구분)</label>
                </div>
                <div class="col-12 col-md-9">
                    <input type="text" id="text-input" name="text-input" class="form-control" value="${map.drive_class_gubun}" style="background-color:white!important;" readonly>
                </div>
            </div>
            <div class="row form-group">
                <div class="col col-md-3">
