...
<script type="text/javascript">
		...
		$(document).ready(function(){
			...
			{	
				document.location.href = "/corona/status/mainStatusView.do";
			}
                ...
                <div class="login-wrap">
                    <div class="login-content">
                        <div class="login-logo">
							<a href="#this" class="btn" id="logout"><img src="/corona/images/popup_title.gif" align="absmiddle"></a>코로나19 관리현황
                        </div>
