		...
		<div class="table-responsive m-b-40">
			...
			<table class="table table-bordered table-data3" style='width: 370;float:left;' id="clinic_table_oversea">
				<thead style='background-color:#0B2161;'>
					...
					<tr align='center'>
						<th width="70%" colspan='3' style='CURSOR:hand;font-weight:bold;' onclick="go_clinicDtl('TODAY','해외','','','${SELDATE}','ISO_EX')">해외입국자(${sumMap.CUR_CLINIC_OVERSEA_TOTAL})</th>
				...
				<tbody>
					<c:forEach items="${selectClinicOverseaMiddleList}" var="item" varStatus="i">
						<tr>
							<td><c:out value="${item.SUSPICION_DAE}" /></td>
							<td><c:out value="${item.SUSPICION_SO}" /></td>
							<td style='CURSOR:hand;color:#0099FF;text-align:center;' onclick="go_clinicDtl('TODAY','해외','${item.SUSPICION_DAE}','${item.SUSPICION_SO}','${SELDATE}','ISO_EX')"><c:out value="${item.SUSPICION_SO_CNT}" /></td> 
							<td style='CURSOR:hand;color:#0099FF;text-align:center;'><c:out value="${item.CONFIRM_CHECK_SUM}" /></td>  
						</tr>
					</c:forEach>
				</tbody>
			</table>
		...
		<div class="table-responsive m-b-40">
			...
			<table class="table table-bordered table-data3" style='width: 370;float:left;' id="clinic_table_oversea">
				<thead style='background-color:#0B2161;'>
					...
					<tr align='center'>
						<th width="70%" colspan='3' style='CURSOR:hand;font-weight:bold;' onclick="go_clinicDtl('TODAY','해외','','','${SELDATE}','ISO')">해외입국자(${sumMap.CUR_CLINIC_ISO_OVERSEA_TOTAL})</th>
				...
				<tbody>
					<c:forEach items="${selectClinicOverseaIsoMiddleList}" var="item" varStatus="i">
						<tr>
							<td><c:out value="${item.SUSPICION_DAE}" /></td>
							<td><c:out value="${item.SUSPICION_SO}" /></td>
							<td style='CURSOR:hand;color:#0099FF;text-align:center;' onclick="go_clinicDtl('TODAY','해외','${item.SUSPICION_DAE}','${item.SUSPICION_SO}','${SELDATE}','ISO')"><c:out value="${item.SUSPICION_SO_CNT}" /></td> 
							<td style='CURSOR:hand;color:#0099FF;text-align:center;' onclick="go_clinicConfirmDtl('TODAY','해외','${item.SUSPICION_DAE}','${item.SUSPICION_SO}','${SELDATE}','ISO')"><c:out value="${item.CONFIRM_CHECK_SUM}" /></td>  
						</tr>
					</c:forEach>
				</tbody>
			</table>
		...
		<div class="table-responsive m-b-40">
			...
			<table class="table table-bordered table-data3" style='width: 370;float:left;' id="clinic_table_oversea">
				<thead style='background-color:#0B2161;'>
					...
					<tr align='center'>
						<th width="70%" colspan='3' style='CURSOR:hand;font-weight:bold;'  onclick="go_clinicDtl('ACCUM','해외','','','','')">해외입국자(${sumMap.CUR_ACCUM_CLINIC_OVERSEA_TOTAL})</th>
				...
				<tbody>
					...
					<c:forEach items="${selectClinicOverseaAccumMiddleList}" var="item" varStatus="i">
						...
						<c:choose>
							...
							<td><c:out value="${item.SUSPICION_SO}" /></td>
							<td style='CURSOR:hand;color:#0099FF;text-align:center;' onclick="go_clinicDtl('ACCUM','해외','${item.SUSPICION_DAE}','${item.SUSPICION_SO}','','')"><c:out value="${item.SUSPICION_SO_CNT}" /></td> 
							<td style='CURSOR:hand;color:#0099FF;text-align:center;' onclick="go_clinicConfirmDtl('ACCUM','해외','${item.SUSPICION_DAE}','${item.SUSPICION_SO}','','')"><c:out value="${item.CONFIRM_CHECK_SUM}" /></td>  
						</tr>
					</c:forEach>
				</tbody>
			</table>
