...
<script type="text/javascript">
		...
		$(document).ready(function(){
			...
			{	
				document.location.href = "/bims/daejang/mainSaupList.do?year=2020";
			}
...
<table  border="0" cellspacing="0" cellpadding="0" class="bodyframe_full">
  <tr>
    ...
    <table width="620" border="0" cellspacing="1" cellpadding="0" class="tbl"> 
      <tr>
        <td class="pupup_title"><a href="#this" class="btn" id="logout"><img src="/bims/images/popup_title.gif" align="absmiddle"></a>주요사업관리시스템</td>
      </tr>
      <tr>
         ...
         <tr>   	           
           ...
           <table border="0" cellspacing="0" cellpadding="0" class="btn" id="changebtn2" style="display:block;">
             <tr>
               ...
               <td background="/bims/images/btn_type0_bg.gif" class="btn_type1" nowrap><a href="#this" class="btn" id="login"><font color="white">로그인</font></a></td>
