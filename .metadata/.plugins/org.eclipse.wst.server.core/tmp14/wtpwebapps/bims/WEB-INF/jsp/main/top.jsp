...
var year = today.getFullYear();
	...
	function fn_home(){
		...
		parent.mbody.location.href="/bims/daejang/mainSaupList.do?year=" + year + "&sgb=M";
...
<tr class="top_box"> 
<td class="logo"><a href="#this" class="btn" id="home1"><img src="/bims/images/main/main_logo21.png" alt="홈으로"></a></td>
<td>
