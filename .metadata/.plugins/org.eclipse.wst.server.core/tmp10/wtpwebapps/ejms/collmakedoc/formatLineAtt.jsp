...
<html:form action="/formatLineAtt" method="post">
  ...
  <tr> 
    ...
    <td width="744" valign="top"> 
      <table width="744" border="0" cellspacing="0" cellpadding="0">
        <!--타이틀-->
        <tr> 
          <logic:lessEqual name="formatLineForm" property="type" value="4"><td background="/images/common/title_bg.gif" height="38" width="644"><img src="/images/collect/title_20.gif" alt="새로만들기"></td></logic:lessEqual>
                ...
                <td valign="top"> 
                  ...
                  <table width="744" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr> 
                      ...
                      <td class="bg2"></td>
                      <td colspan="5" class="t1"><bean:write name="formatLineForm" property="formkindname"/></td>
                    </tr>
                    <tr> 
                      <td colspan="7" class="bg1"></td>
                    </tr>
									...
									<tr>
										<td>
											<select name="userList" size="10" style="width:150; border:0; display:block" onclick="masterListSelect(userList, detailList, masterCode, detailCode, 'show')">
												<bean:write name="formatLineForm" property="attoption1" filter="false"/>
											</select>
											<select name="adminList" size="10" style="width:150; border:0; display:none" onclick="masterListSelect(adminList, detailList, masterCode, detailCode, 'hide')">
												<bean:write name="formatLineForm" property="attoption2" filter="false"/>
											</select>
										</td>
										<td width="5">&nbsp;</td>
									  <td>
            ...
            <table width="744" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr bgcolor="#F6F6F6"> 
                ...
                <td bgcolor="#F6F6F6" align="right" height="35">
	                <a href="javascript:click_preview('/formatLineProcPreview.do')"><img src="/images/common/btn_view.gif" align="absmiddle" alt="미리보기" border="0"></a>
                	<a href="javascript:click_prev('/formatLineDef.do')"><img src="/images/common/btn_back.gif" align="absmiddle" alt="이전" border="0"></a>
                	<a href="javascript:click_preview('/formatLineProcPreview.do?saveCheck=1')"><img src="/images/common/btn_complete.gif" align="absmiddle" alt="완료" border="0"></a>
