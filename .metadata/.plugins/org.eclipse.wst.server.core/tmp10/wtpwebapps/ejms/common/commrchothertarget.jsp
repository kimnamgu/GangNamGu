  ...
  <tr> 
    ...
    <td width="744" height="364" valign="top"> 
      <table width="744" border="0" cellspacing="0" cellpadding="0">
        <!--타이틀-->
        <tr> 
          <td background="/images/common/title_bg.gif" height="38" width="744"><img src="/images/collect/title_41.gif" height="38" alt="대상지정"></td>
        </tr>
        <tr> 
            ...
            <table width="744" border="0" cellspacing="0" cellpadding="0" align="center">
              <tr> 
                ...
                <td width="332" valign="top" align="right"> 
                  ...
                  <table width="320" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      <td width="76"><img src="/images/collect/tab_05_off.gif" width="74" height="28" alt="설문대상"></td>
                      <td width="244">&nbsp;</td>
                    </tr>
                    <tr> 
                      <td colspan="2"> 
