...
<!--
	...
	function listReload() {
		if ( doClose == true ) {
			...
			opener.location.href = "/grpList.do?grplistcd=" + document.forms[0].grplistcd.value+'&posi='+ppos+'&cposi='+cpos;
			window.close();
		}
	}
...
<html:hidden property="grplistcd"/>
...
<table width="680" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr> 
    <td bgcolor="#0098E6" width="5"></td>
    <td width="13"></td>
    <td width="644" valign="top" height="139"> 
      <table width="644" border="0" cellspacing="0" cellpadding="0">
        <!--타이틀-->
        <tr> 
          <td background="/images/common/title_bg.gif" height="38" width="644"><img src="/images/admin/title_04.gif" alt="배포목록 마스터수정" width="147" height="38" /></td>
        </tr>
        <tr> 
                ...
                <td valign="top"> 
                  ...
                  <table width="644" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr> 
                      ...
                      <td class="bg2"></td>
                      <td class="t1"><bean:write name="groupForm" property="grplistcd"/></td>
                    </tr>
                    <tr> 
                    ...
                    <tr> 
                      ...
                      <td class="bg2"></td>
                      <td class="t1"><html:text property="grplistnm" style="width:95%" maxlength="25"/></td>
                    </tr>
                    <tr> 
                      <td colspan="3" class="bg1"></td>
                    </tr>
                    <tr> 
                      <td width="120" class="s1"><img src="/images/common/dot_02.gif" width="15" height="11" align="absmiddle" alt="">순서</td>
                      <td class="bg2"></td>
                      <td class="t1"><html:text property="ord" style="width:95%" maxlength="3" onkeydown="key_num()"/></td>
                    </tr>
                    <tr> 
                      <td colspan="3" class="bg1"></td>
                    </tr>
