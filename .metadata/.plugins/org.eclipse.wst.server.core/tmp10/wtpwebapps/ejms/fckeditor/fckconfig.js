...
FCKConfig.ToolbarSets["ejms_formMake"] = [
	['NewPage','Table',"-"]
] ;

FCKConfig.ToolbarSets["ejms_basic"] = [
	['FontName','FontSize','TextColor','-','Bold','Italic','Underline','StrikeThrough','Subscript','Superscript','-',
	 'JustifyLeft','JustifyCenter','JustifyRight','JustifyFull','-',
	 'OrderedList','UnorderedList','Outdent','Indent','-',
	 'Table','SpecialChar','Link','Image','Source']
] ;
...
FCKConfig.FontNames		= '바탕;바탕체;굵은바탕체;굴림;굴림체;굵은굴림체;돋움;돋움체;굵은돋움체;궁서;궁서체;그래픽체;굵은그래픽체;고딕;고딕체;명조;;Arial;Comic Sans MS;Courier New;Tahoma;Times New Roman;Verdana' ;
