...
dtmlXMLLoaderObject.prototype.loadXML = function (filePath, async) {
	if(async == undefined) async = "true";
	try {
		// if IE7, Mozilla, Safari, etc : Use Native Object
		this.xmlDoc = new XMLHttpRequest();
		this.xmlDoc.open("GET", filePath, async);
		...
		} else {			// if ..otherwise, use ActiveX control for IE5.x and IE6
			this.xmlDoc = new ActiveXObject("Microsoft.XMLDOM");
...
dhtmlDragAndDropObject.prototype.callDrag = function (e) {
	...
	dragger.dragNode.style.left = e.clientX + 15 + document.body.scrollLeft;
	dragger.dragNode.style.top = e.clientY + 3 + document.body.scrollTop;
	if (!e.srcElement) {
		var z = e.target;
	} else {
		z = e.srcElement;
...
dhtmlDragAndDropObject.prototype.stopDrag = function (e) {
	...
	if (dragger.lastLanding) {
		dragger.lastLanding.dragLanding._drag(dragger.dragStartNode, dragger.dragStartObject, dragger.lastLanding);
	}
