          ...
          <td height="6" valign="top"> 
            <table width="820" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td> 
                  <!--상단 선택메뉴 테이블-->
									<bean:define id="chrgusrcd" name="collprocForm" property="chrgusrcd"/>	
                  <table width="820" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      ...
                      <td width="810" background="/images/common/select_bg.gif"> 
                        <table width="800" border="0" cellspacing="0" cellpadding="0" align="center">
                          <tr> 
                            ...
                            <td><img src="/images/collect/s_m_01.gif" width="94" height="41" alt="취합문서정보" style="cursor:hand" onclick="location.href='/exhibitInfoView.do?formkind=<%=formkind%>&sysdocno=<%=sysdocno%>&formseq=<%=formseq%>&frmScrollTop=' + formFrame.document.body.scrollTop"></td>
...
<table width="865" border="0" cellspacing="0" cellpadding="0">
<html:form action="/exhibit/formatLineView.do" method="POST">
...
<table width="865" border="0" cellspacing="0" cellpadding="0">
<html:form action="/exhibit/formatFixedView.do" method="POST">
<html:hidden property="sysdocno" value="<%=sysdocno %>"/>
<html:hidden property="formseq" value="<%=formseq %>"/>
  <tr> 
    <td width="20">&nbsp;</td>
...
<table width="865" border="0" cellspacing="0" cellpadding="0">
<html:form action="/exhibit/formatBookView.do" method="POST">
<html:hidden property="sysdocno" value="<%=sysdocno %>"/>
<html:hidden property="formseq" value="<%=formseq %>"/>
  <tr> 
    <td width="20">&nbsp;</td>
					  ...
					  <table width="820" border="0" cellspacing="0" cellpadding="0">
					    ...
					    <logic:notEmpty name="dataForm" property="filenm">
						    <tr> 
						      ...
						      <td class="bg3"></td>
						      <td colspan="9" class="t1">
										<a class="list_s2" target="actionFrame" href="/download.do?tempFileName=<bean:write name="dataForm" property="filenm"/>&fileName=<bean:write name="dataForm" property="originfilenm"/>"><bean:write name="dataForm" property="originfilenm"/></a>
									</td>
						    </tr>
						    <tr> 
						      <td colspan="11" class="list_bg4"></td>
