...
<bean:define id="docstate" name="collprocForm" property="docstate"/>
<%
String procImg = "";
                    ...
                    <tr> 
                      ...
                      <td width="810" background="/images/common/select_bg.gif"> 
                        <table width="800" border="0" cellspacing="0" cellpadding="0" align="center">
                          <tr> 
                            <td width="94"><img src="/images/collect/s_m_01.gif" width="94" height="41" alt="취합문서정보" style="cursor:hand" onclick="location.href='/collprocInfoView.do?formkind=<%=formkind%>&sysdocno=<%=sysdocno%>&formseq=<%=formseq%>&frmScrollTop=' + formFrame.document.body.scrollTop"></td>
                            ...
                            <td align="right" valign="bottom" style="padding:0 0 1 0;" id="changeicon">
                           	<%  if( docstate.equals("06")){ %>
						                ...
						                <%  } %>
                              <img src="/images/common/btn_list.gif" alt="목록보기" style="cursor:hand" onclick="location.href='/collprocList.do?docstate=0'">
                            </td>
                          </tr>
                        </table>
                      </td>
...
<table width="865" border="0" cellspacing="0" cellpadding="0">
<html:form action="/collproc/formatLineView.do" method="POST">
...
<table width="865" border="0" cellspacing="0" cellpadding="0">
<html:form action="/collproc/formatFixedView.do" method="POST">
<html:hidden property="sysdocno" value="<%=sysdocno %>"/>
<html:hidden property="formseq" value="<%=formseq %>"/>
  <tr> 
    <td width="20">&nbsp;</td>
...
<table width="865" border="0" cellspacing="0" cellpadding="0">
<html:form action="/collproc/formatBookView.do" method="POST">
<html:hidden property="sysdocno" value="<%=sysdocno %>"/>
<html:hidden property="formseq" value="<%=formseq %>"/>
  <tr> 
    <td width="20">&nbsp;</td>
