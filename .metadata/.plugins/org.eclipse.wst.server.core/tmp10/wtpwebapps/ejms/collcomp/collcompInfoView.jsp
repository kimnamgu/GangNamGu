                ...
                <td>
                  <table width="820" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr> 
                      ...
                      <td class="bg2"></td>
                      <td class="s1" width="100"><img src="/images/common/dot_02.gif" width="15" height="11" align="absmiddle" alt="">마감일시</td>
                      <td class="bg2"></td>
                      <td class="t1"><bean:write name="commCollDocInfoForm" property="enddt"/></td>
                      <td></td>
                      <td></td>
                    </tr>
                    <tr> 
