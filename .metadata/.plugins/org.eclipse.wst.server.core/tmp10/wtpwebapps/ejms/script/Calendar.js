...
document.writeln('<iframe id="Cal_iFrame" width=160 height=130 src="/script/cal.html" scrolling=no frameborder=no border=1 bordercolor=red title="캘린더" oncontextmenu="return false" ondragstart="return false" onselectstart="return false"></iframe>');
