  ...
  <tr> 
    ...
    <td width="843" valign="top"> 
      <table width="843" border="0" cellspacing="0" cellpadding="0">
        <!--타이틀-->
        <tr> 
          <td background="/images/common/title_bg.gif" height="38"><img src="/images/admin/title_07.gif" alt=""></td>
                  ...
                  <table width="820" border="0" cellspacing="2" cellpadding="0" bgcolor="#ECF3F9" height="42">
                    <tr> 
                      <td bgcolor="#FFFFFF" style="padding:3 0 3 0;"> 
                        <!--마감시한/알림말 테이블 시작-->
                        <html:form method="POST" action="/collsttcsList">
                        <table width="810" border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="#F7F7F7" height="32">
                          <tr> 
                            ...
                            <td height="20" width="370">
															...
															<% ((nexti.ejms.statistics.form.CollsttcsForm)request.getAttribute("collsttcsForm")).setOrggbn((String)session.getAttribute("user_gbn")); %>
															<% } %>
															<logic:notEqual name="collsttcsForm" property="orggbn" value="">
																<html:select property="orggbn_dt" style="width:250px;background-color:white" onchange="submit()">
																	<jsp:useBean id="orggbn_dt" class="nexti.ejms.list.form.DeptDetailListForm">
																		<bean:define id="orggbn" name="collsttcsForm" property="orggbn"/>
              ...
              <tr> 
                <td valign="top"> 
                  ...
                  <table width="820" border="0" cellspacing="0" cellpadding="0" id="tbl">
                    ...
                    <tr>
                    	<logic:equal name="collsttcsForm" property="gbn" value="0">
                    		<td class="list_t" width="100">연번</td>
	                      <td class="list_t" width="480" colspan="2">부서명</td>
	                      <td class="list_t" width="240">취합회수</td>
                    	</logic:equal>
                    	<logic:equal name="collsttcsForm" property="gbn" value="1">
                    		<td class="list_t" width="100">연번</td>
                    ...
                    <logic:notEmpty name="collsttcsForm" property="list">
											<logic:iterate id="list" name="collsttcsForm" property="list" indexId="i">
		                    <tr <% if (i.intValue() % 2 != 0) out.print("class=\"list_bg3\" onMouseOut=\"this.style.background='#F5FAFF'\"");%> onMouseOut="this.style.background='#ffffff'" onMouseOver="this.style.background='#FFFAD1'">
		                    	<logic:equal name="collsttcsForm" property="gbn" value="0">
			                      ...
			                      <td class="list_l" colspan="2"><bean:write name="list" property="colDeptNm"/></td>
			                      <td class="list_l"><bean:write name="list" property="chrgCount"/></td>
		                    	</logic:equal>
		                    	<logic:equal name="collsttcsForm" property="gbn" value="1">
		                    		<td class="list_no"><bean:write name="list" property="seqno"/></td>
			                      <td class="list_l"><bean:write name="list" property="colDeptNm"/></td>
			                      <td class="list_l"><bean:write name="list" property="chrgUsrNm"/></td>
			                      <td class="list_l"><bean:write name="list" property="chrgCount"/></td>
		                    	</logic:equal>
		                    </tr>
		                    <tr> 
                    	...
                    	<bean:define id="list" name="collsttcsForm" property="list" type="java.util.ArrayList"/>
                    	<tr <% if (list.size() % 2 != 0 & false) out.print("class=\"list_bg3\" onMouseOut=\"this.style.background='#F5FAFF'\"");%> onMouseOut="this.style.background='#ffffff'" onMouseOver="this.style.background='#FFFAD1'">
	                      ...
	                      <td class="list_l">&nbsp;</td>
	                      <td class="list_l">&nbsp;</td>
	                      <td class="list_l"><bean:write name="collsttcsForm" property="totcount"/></td>
	                    </tr>
	                    <tr> 
	                      <td colspan="4" class="list_bg2"></td>
	                    </tr>
                    </logic:notEmpty>
                    <logic:empty name="collsttcsForm" property="list">
                    	<tr> 
