...
<%
	...
	String viewRchno = request.getParameter("rchno");
%>
					...
					<td height="6" valign="top">
						<table width="820" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
				                ...
				                <% } %>
										...
										<tr id="opentype1" style="display:block">
											<td width="100" class="s1"><img src="/images/common/dot_02.gif" align="absmiddle" alt=""><b>설문공개여부</b></td>
											<td class="bg2"></td>
											<td class="t1">
										...
										<% if ( nexti.ejms.common.appInfo.isUsrdept() ) { %>
											...
											<tr id="tgtdept5" style="display:block">
												<td class="t1" height="25">
													...
													<a href="javascript:showModalPopup('/commrchothertarget.do?rchno=<%=rchno %>&rchgrpno=<%=rchgrpno %>',680,402,0,0)"><img src="/images/common/btn_select5.gif" align="absmiddle" alt="대상지정"></a>
												</td>												
											</tr>
										...
										<tr>
											...
											<td class="t1">
												<logic:notEqual name="researchForm" property="anscount" value="0">
													<html:text property="formcount" maxlength="2" size="5" style="text-align:center" readonly="true"/>&nbsp;문항&nbsp;&nbsp;&nbsp;
	                    	...
	                    	<logic:equal name="researchForm" property="anscount" value="0">
													<html:text property="formcount" maxlength="2" size="5" style="text-align:center" onkeydown="key_num();"/>&nbsp;문항&nbsp;
