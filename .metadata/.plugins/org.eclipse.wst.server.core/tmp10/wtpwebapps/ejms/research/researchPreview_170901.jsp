...
<body  leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onload="fullSizeWindow(-1, (screen.availHeight * 0.8))" style="overflow:hidden;">
							...
							<div class="survey-list-form">
								<ul>
						        	...
						        	<logic:equal name="list" property="examtype" value="Y">
						        		<li>
						        		<input type="radio" name="anscont<%=idx.intValue() %>" style="border:0;background-color:transparent;" value="">
						        		<label for="">기타&nbsp;:&nbsp;<input type="text" name="other<%=idx.intValue() %>" style="width:93%;" maxlength="2000"></label>
										</li>
						        	</logic:equal>
						        	</logic:equal>
						        	<logic:equal name="list" property="formtype" value="02">		 
									<logic:equal name="list" property="examtype" value="Y">
										<li>
											<input type="checkbox" name="anscont<%=idx.intValue() %><%=elistsize.intValue()%>" style="border:0;background-color:transparent;" value="">
											<label for="">기타&nbsp;:&nbsp;<input type="text" name="other<%=idx.intValue() %>" style="width:93%;" maxlength="2000"></label>
										</li>
									</logic:equal>
									</logic:equal>
