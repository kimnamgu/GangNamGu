...
<input type="hidden" name="rchno" id="rchno" value="<bean:write name="researchForm" property="rchno"/>">
			...
			<div class="survey-wrap">
							...
							<div class="survey-list-form">
								<ul>
										...
										<bean:define id="eseq" name="elist" property="examseq" />
									   		<logic:equal name="list" property="formtype" value="01">
										   		<li>
										   			...
										   			<input type="radio" name="anscont<%=idx.intValue() %>" style="border:0;background-color:transparent;" value="<%=eseq.toString() %>"  onclick="ex_research('<bean:write name="list" property="formseq"/>','<%=eseq.toString() %>', '<bean:write name="list" property="ex_frsq"/>','<bean:write name="list" property="ex_exsq"/>','<%=elistsize %>','<%=idx.intValue() %>')">
						        	...
						        	<logic:equal name="list" property="examtype" value="Y">
						        		<li>
						        		<input type="radio" name="anscont<%=idx.intValue() %>" style="border:0;background-color:transparent;margin-top:6px;" value="" onclick="ex_research('<bean:write name="list" property="formseq"/>','0', '<bean:write name="list" property="ex_frsq"/>','<bean:write name="list" property="ex_exsq"/>','<%=elistsize %>','<%=idx.intValue() %>')">
				...
				<div class="text-center mb20">
					<logic:equal name="researchForm" property="mode" value="getused">
							<a href="javascript:choice('<bean:write name="researchForm" property="rchno"/>')" class="btn-join">선택하기</a>
