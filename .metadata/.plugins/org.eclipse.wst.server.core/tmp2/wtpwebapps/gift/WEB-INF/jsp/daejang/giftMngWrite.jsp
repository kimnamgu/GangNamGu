...
<script type="text/javascript">
		...
		function fn_giftMngWrite(){
			...
			{	
				if(check == "")
					comSubmit.setUrl("<c:url value='/daejang/insertGiftMng.do' />");
				else
					comSubmit.setUrl("<c:url value='/daejang/updateGiftMng.do' />");
	      ...
	      <table width="100%" border="0" cellspacing="1" cellpadding="0" class="tbl" id="divMemoMainBody" style="display:block;">	      	  	      	  
			  ...
			  <tr>
	            ...
	            <td colspan="3" width="607" class="tbl_list_left">
	                <input type="text" id="TAKE_DATE" name="TAKE_DATE" value="<fmt:parseDate value="${map.TAKE_DATE}" var="dateFmt1" pattern="yyyyMMdd"/><fmt:formatDate value="${dateFmt1}" pattern="yyyy-MM-dd"/>" class="input" style="width:90;"> <a href="#a" onclick="popUpCalendar(this, TAKE_DATE, 'yyyy-mm-dd');"><img class="Lbtn" src="/gift/images/ic_cal.gif" alt="달력" /></a>                
	            </td>								
	          </tr>			  
			  <tr>
	            <td width="120" class="tbl_field">선물수령자</td>
	            <td colspan="3" width="607" class="tbl_list_left">
	                                     총무과 (직급  : <input type="text" id="TAKE_PSN_CLASS_NM" name="TAKE_PSN_CLASS_NM" value="${map.TAKE_PSN_CLASS_NM}" class="input" style="width:100;"> &nbsp;&nbsp; 성명 : <input type="text" id="TAKE_PSN_NM" name="TAKE_PSN_NM" value="${map.TAKE_PSN_NM}" class="input" style="width:100;"> ) &nbsp;&nbsp;<input type="text" id="USER_NAME" name="USER_NAME" class="input" style="width:100;"> <a href="#this" name="search" id="open" class="bk">찾기</a>             
	            </td>
	          </tr>
	          <tr>
	            <td width="120" class="tbl_field">보관장소</td>
	            <td colspan="3" width="607" class="tbl_list_left">
	                <input type="text" id="KEEP_PLACE" name="KEEP_PLACE" value="${map.KEEP_PLACE}" class="input" style="width:250;">	                
	            </td>
	          </tr>
	          <tr>
