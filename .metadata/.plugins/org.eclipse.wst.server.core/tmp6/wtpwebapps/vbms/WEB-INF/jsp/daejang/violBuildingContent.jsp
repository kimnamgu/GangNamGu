...
<script type="text/javascript">
		...
		function fn_initial_setting(){
			...
			$("#BLD_STRUCTURE").val("${map.BLD_STRUCTURE}");
			$("#PURPOSE").val("${map.PURPOSE}");
			$("#STATE").val("${map.STATE}");
		}
		...
		function fn_updateViolBuilding(){
			...
			{			
				...
				$('#MBLD_ADDR2').val($('#maddrDetail').val());
			...
			{							
				comSubmit.setUrl("<c:url value='/daejang/updateBldMngDaejang.do' />");									
				comSubmit.submit();
			}
		}
		...
		function fn_deleteViolBuilding(){
			var comSubmit = new ComSubmit("form1");
			var tmp = "";
						
			if(confirm('데이터를 삭제 하시겠습니까?'))
			{							
				comSubmit.setUrl("<c:url value='/daejang/deleteBldMngDaejang.do' />");									
				comSubmit.submit();
			}
		}
		...
		function mjusoCallBack(roadFullAddr,roadAddrPart1,addrDetail,roadAddrPart2,engAddr, jibunAddr, zipNo, admCd, rnMgtSn, bdMgtSn,detBdNmList,bdNm,bdKdcd,siNm,sggNm,emdNm,liNm,rn,udrtYn,buldMnnm,buldSlno,mtYn,lnbrMnnm,lnbrSlno,emdNo){
			...
			document.form1.MBLD_ADDR_ROAD.value = roadAddrPart1.substring(roadAddrPart1.indexOf(findStr)+1); //도로명주소 (강남구 이전 제외 )
		...
		function set_param(){
			...
			/*var findStr = "구 ";				
			var StrArray = $('#jibunAddr').val().split(' ');
			var strbuff = "";
										
			document.form1.BLD_DONG.value = StrArray[2];			
			document.form1.BLD_ADDR2.value = $('#addrDetail').val();		
			document.form1.BLD_ADDR1.value = StrArray[3];  // 지번주소(동 이전 제외)				
			document.form1.BLD_ADDR_ROAD.value =  $('#roadAddrPart1').val().substring($('#roadAddrPart1').val().indexOf(findStr)+1); //도로명주소 (강남구 이전 제외 )
			*/
			input_chk = 1;
			input_chk2 = 1;
		}
...
<input type="hidden" id="BLD_DONG" name="BLD_DONG" value="${map.BLD_DONG}">
...
<input type="hidden" id="MBLD_DONG" name="MBLD_DONG" value="${map.MBLD_DONG}">
        ...
        <!--리스트 시작 -->
	      <table width="100%" border="0" cellspacing="1" cellpadding="0" class="tbl" id="divMemoMainBody" style="display:block;">	                 				 	          
	          <tr>
	            ...
	            <td width="630" colspan="3" class="tbl_list_left"><input type="text" id="BLD_ZIPNO" name="BLD_ZIPNO" value="${map.BLD_ZIPNO}" class="input" style="width:70;"> &nbsp;<input type="text" id="jibunAddr" name="jibunAddr" value="${map.FULL_BLD_ADDR}" class="input" style="width:300;">&nbsp; <input type="text" id="addrDetail" name="addrDetail" value="${map.BLD_ADDR2}" class="input" style="width:100;">	            
	          ...
	          <tr>
	            ...
	            <td width="630" colspan="3" class="tbl_list_left"><input type="text" id="roadAddrPart1" name="roadAddrPart1" value="${map.FULL_BLD_ADDR_ROAD}" class="input" style="width:400;"></td>									
	          </tr>
	          <tr>
	            <td width="140" class="tbl_field">건축주</td>
	            <td width="630" colspan="3" class="tbl_list_left"><input type="text" id="BLD_OWNER" name="BLD_OWNER" value="${map.BLD_OWNER}" class="input" style="width:200;"></td>									
	          </tr>
	          <tr>
	            <td width="140" class="tbl_field">건축주 주소</td>
	            <td width="630" colspan="3" class="tbl_list_left"><input type="text" id="MBLD_ZIPNO" name="MBLD_ZIPNO" value="${map.MBLD_ZIPNO}" class="input" style="width:70;"> &nbsp;<input type="text" id="mjibunAddr" name="mjibunAddr" value="${map.MFULL_BLD_ADDR}" class="input" style="width:300;">&nbsp; <input type="text" id="maddrDetail" name="maddrDetail" value="${map.MBLD_ADDR2}" class="input" style="width:100;">	            
	          ...
	          <tr>
	            ...
	            <td width="630" colspan="3" class="tbl_list_left"><input type="text" id="mroadAddrPart1" name="mroadAddrPart1" value="${map.MFULL_BLD_ADDR_ROAD}" class="input" style="width:400;"></td>									
	          </tr>	          
	          <tr>
	            ...
	            </select> &nbsp;&nbsp;<input type="text" id="STRUCTURE_DETAIL" name="STRUCTURE_DETAIL" value="${map.STRUCTURE_DETAIL}" class="input" style="width:200;">
	            </td>									
	          </tr>
	          <tr>
	            <td width="140" class="tbl_field">면적</td>
	            <td width="630" colspan="3" class="tbl_list_left"><input type="text" id="VIOL_AREA" name="VIOL_AREA" value="${map.VIOL_AREA}" class="input" style="width:200;"></td>									
	          </tr>	          
	          <tr>
	            ...
	            <select id="PURPOSE" name="PURPOSE" class="input">
	            	<option value="00">--------</option>	                	
	            </select> &nbsp;<input type="text" id="PURPOSE_DETAIL" name="PURPOSE_DETAIL" value="${map.PURPOSE_DETAIL}" class="input" style="width:200;">
	            </td>									
	          </tr>
	          <tr>
	            <td width="140" class="tbl_field">층</td>
	            <td width="630" colspan="3" class="tbl_list_left"><input type="text" id="LOCATION" name="LOCATION" value="${map.LOCATION}" class="input" style="width:200;"></td>									
	          </tr>
	          <tr>
	            <td width="140" class="tbl_field">적발방법</td>
	            <td width="630" colspan="3" class="tbl_list_left"><input type="text" id="EXPOSURE_DETAILS" name="EXPOSURE_DETAILS" value="${map.EXPOSURE_DETAILS}" class="input" style="width:200;"></td>									
	          </tr>	          
	          <tr>
	            <td width="140" class="tbl_field">시정명령 사전예고</td>
	            <td width="630" colspan="3" class="tbl_list_left"><input type="text" id="PRE_CORRTN_ORDER" name="PRE_CORRTN_ORDER" value="<fmt:parseDate value="${map.PRE_CORRTN_ORDER}" var="dateFmt1" pattern="yyyyMMdd"/><fmt:formatDate value="${dateFmt1}" pattern="yyyy-MM-dd"/>" class="input" style="width:200;"></td>									
	          </tr>
	          <tr>
	            <td width="140" class="tbl_field">시정명령</td>
	            <td width="630" colspan="3" class="tbl_list_left"><input type="text" id="CORRTN_ORDER" name="CORRTN_ORDER" value="<fmt:parseDate value="${map.CORRTN_ORDER}" var="dateFmt1" pattern="yyyyMMdd"/><fmt:formatDate value="${dateFmt1}" pattern="yyyy-MM-dd"/>" class="input" style="width:200;"></td>									
	          </tr>
	          <!--
	          <tr>
	            <td width="140" class="tbl_field">위반건축물 등재일</td>
	            <td width="630" colspan="3" class="tbl_list_left"><input type="text" id="VIOL_BUILDING_REGDATE" name="VIOL_BUILDING_REGDATE" value="<fmt:parseDate value="${map.VIOL_BUILDING_REGDATE}" var="dateFmt1" pattern="yyyyMMdd"/><fmt:formatDate value="${dateFmt1}" pattern="yyyy-MM-dd"/>" class="input" style="width:200;"></td>									
	          </tr>
	          <tr>
	            <td width="140" class="tbl_field">세무과통보</td>
	            <td width="630" colspan="3" class="tbl_list_left"><input type="text" id="TAX_DEP_NOTEDATE" name="TAX_DEP_NOTEDATE" value="<fmt:parseDate value="${map.TAX_DEP_NOTEDATE}" var="dateFmt1" pattern="yyyyMMdd"/><fmt:formatDate value="${dateFmt1}" pattern="yyyy-MM-dd"/>" class="input" style="width:200;"></td>									
	          </tr>
	          -->
	          <tr>
	            <td width="140" class="tbl_field">이행강제금부과 사전예고</td>
	            <td width="630" colspan="3" class="tbl_list_left"><input type="text" id="OPINION_STATE_LIMIT" name="OPINION_STATE_LIMIT" value="<fmt:parseDate value="${map.OPINION_STATE_LIMIT}" var="dateFmt1" pattern="yyyyMMdd"/><fmt:formatDate value="${dateFmt1}" pattern="yyyy-MM-dd"/>" class="input" style="width:200;"></td>									
	          </tr>
	          <tr>
	            <td width="140" class="tbl_field">이행강제금부과일</td>
	            <td width="630" colspan="3" class="tbl_list_left"><input type="text" id="EXEC_IMPOSE_DATE" name="EXEC_IMPOSE_DATE" value="<fmt:parseDate value="${map.EXEC_IMPOSE_DATE}" var="dateFmt1" pattern="yyyyMMdd"/><fmt:formatDate value="${dateFmt1}" pattern="yyyy-MM-dd"/>" class="input" style="width:200;"></td>									
	          </tr>
	          <tr>
	            <td width="140" class="tbl_field">이행강제금</td>
	            <td width="630" colspan="3" class="tbl_list_left"><input type="text" id="EXEC_IMPOSE_AMT" name="EXEC_IMPOSE_AMT" value="<fmt:formatNumber value="${map.EXEC_IMPOSE_AMT}" pattern="###,###,###" />" class="input" style="width:200;"></td>									
	          </tr>
	          ...
	          <tr>
	            ...
	            <select id="STATE" name="STATE" class="input">
	            	<option value="00">------</option>	                	
	            </select> &nbsp;&nbsp;&nbsp;&nbsp;<input type="text" id="STATE_DETAIL" name="STATE_DETAIL" value="${map.STATE_DETAIL}" class="input" style="width:100;">
	            </td>									
	          </tr>
	          ...
	          <tr>
	            ...
	            <td width="630" colspan="3" class="tbl_list_left"><input type="text" id="PERFORM_PERSON" name="PERFORM_PERSON" value="${map.PERFORM_PERSON}" class="input" style="width:200;"> 
	          ...
	          <tr>
	            ...
	            <td width="630" colspan="3" class="tbl_list_left"><input type="text" id="BIGO" name="BIGO" value="${map.BIGO}" class="input" style="width:200;"></td>									
	          </tr>
	      </table>
               ...
               <td>
                <table border="0" cellspacing="0" cellpadding="0" class="btn" id="changebtn2" style="display:block;">
                  <tr>
                    ...
                    <td background="/vbms/images/btn_type0_bg.gif" class="btn_type1" nowrap><a href="#this" class="btn" id="mod"><font color="white">수정</font></a></td>
                ...
                <table border="0" cellspacing="0" cellpadding="0" class="btn" id="changebtn2" style="display:block;">
                  <tr>
                    <td><img src="/vbms/images/btn_type0_head.gif"></td>
                    <td background="/vbms/images/btn_type0_bg.gif" class="btn_type1" nowrap><a href="#this" class="btn" id="del"><font color="white">삭제</font></a></td>
                    <td><img src="/vbms/images/btn_type0_end.gif"></td>
                  </tr>
                </table>
                </td>                               	
