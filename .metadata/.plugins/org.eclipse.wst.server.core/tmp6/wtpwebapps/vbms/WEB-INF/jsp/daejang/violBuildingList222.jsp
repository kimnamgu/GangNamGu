			...
			if(total == 0){
				...
				$.each(data.list, function(key, value){
						   ...
						   str += "<tr class=\"" + tr_class + "\">" + 
						   			   ...
						   			   td_class + NvlStr(value.PURPOSE_DETAIL) + "</td>" +
						   			   ...
						   			   td_class + formatDate(NvlStr(value.VIOL_BUILDING_REGDATE),".") + "</td>" +
						   			   td_class + formatDate(NvlStr(value.TAX_DEP_NOTEDATE), ".") + "</td>" + 
   ...
   <table width="100%" height="40" border="0" cellspacing="0" cellpadding="0" id="divMemoMainBody2">    
     ...
     <thead>
        <tr>
          ...
          <th>용도</th><th>상세용도</th><th>위치</th><th>적발방법</th>
          <th>사전예고</th><th>시정명령</th><th>위법건축물등재일</th><th>세무과통보</th>
          <th>이행강제금 부과 사전예고</th><th>이행강제금부과일</th>
          <th>이행강제금부과액</th><th>처리결과</th><th>비고</th>    
        </tr>
      </thead>
      <tbody id='mytable'>     
      </tbody>
