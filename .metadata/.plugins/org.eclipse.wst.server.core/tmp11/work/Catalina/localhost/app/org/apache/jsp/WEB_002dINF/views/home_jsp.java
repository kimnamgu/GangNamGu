 ...
 * Generated at: 2020-03-17 08:23:15 UTC
...
return;
    ...
    try {
      ...
      out.write("            ws = new WebSocket('ws://localhost:8099/app/echo.do');\n");
      out.write("            writeResponse(\"WebSocket opend!!.\");\n");
      out.write("            \n");
      out.write("            ws.onopen=function(event){\n");
      out.write("                if(event.data===undefined) return;\n");
