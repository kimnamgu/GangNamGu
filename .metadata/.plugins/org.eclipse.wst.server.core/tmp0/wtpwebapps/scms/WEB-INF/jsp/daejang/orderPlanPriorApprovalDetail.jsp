...
<script type="text/javascript">
		...
		$(document).ready(function(){
			...
			$("#orderOk").on("click", function(e){ //승인하기 버튼				
				e.preventDefault();
				if( $('#USER_RIGHT').val() == 'A' )
				{		
					fn_orderOk();
...
<input type="hidden" id="GUBUN" name="GUBUN" value="${map.GUBUN}"> 
...
<table  border="0" cellspacing="0" cellpadding="0" class="bodyframe_full">
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td class="pupup_title"><img src="/scms/images/popup_title.png" align="absmiddle">발주계획 수정 ${map.GUBUN}</td>
      </tr>
      <tr>
        ...
        <!--리스트 시작 -->
	      <table width="100%" border="0" cellspacing="1" cellpadding="0" class="tbl" id="divMemoMainBody" style="display:block;">
	          ...
	          <tr>
	            ...
	            <td width="607" colspan="3" class="tbl_list_left"><input type="text" id="SAUP_BUDGET_AMT" name="SAUP_BUDGET_AMT" maxlength="13" value="<fmt:formatNumber value="${map.SAUP_BUDGET_AMT}" pattern="###,###,###" />" class="input" style="width:300;"> <b>원</b></td>									
	          </tr>	         	         	          
	          <tr>
              ...
              <c:choose>
                ...
                <table border="0" cellspacing="0" cellpadding="0" class="btn" id="changebtn2" style="display:block;">
                  <tr>
                    ...
                    <td background="/scms/images/btn_type0_bg.gif" class="btn_type1" nowrap><a href="#this" class="btn" id="orderOk"><font color="white">승인</font></a></td>
