...
<script type="text/javascript">
		...
		$(document).ready(function(){
			...
			$("a[name='filenm3']").on("click", function(e){ //파일명 
				e.preventDefault();
				fn_downloadFile3($(this));
			});
						
		});
		
		function fn_prvCnrtCompList(){
			var comSubmit = new ComSubmit();
			comSubmit.setUrl("<c:url value='/daejang/prvCnrtCompList.do' />");
			comSubmit.addParam("COMP_NM", "${param.COMP_NM}");
			comSubmit.addParam("COMP_KEYWORD", "${param.COMP_KEYWORD}");
			comSubmit.submit();
		}
		...
		function fn_downloadFile(obj){
			...
			//var idx = obj.parent().find("input[name='FID']").val();	
			var comSubmit = new ComSubmit();
	      ...
	      <table width="100%" border="0" cellspacing="1" cellpadding="0" class="tbl" id="divMemoMainBody" style="display:block;">
	          ...
	          <tr>
	            <td width="100%" colspan="6" class="tbl_fieldT">
		            ...
		            <td width="15%" align="right"><a href="#this" class="w_btn" id="record">등록</a> &nbsp;</td>
		            </tr>
		            </table>	            		           
	            </td>	           							
	          </tr>
	          ...
	          <tr>
	           ...
	           <tr>
	            ...
	            <td width="15%" align="right"><a href="#this" class="w_btn" id="reason">등록</a> &nbsp;</td>
	            </tr>
	            </table>
	            </td>	                  						
	           </tr>
	          <tr>
	            ...
	            <td width="312" class="tbl_fieldc">선정사유</td>
	            <td width="171" class="tbl_fieldc">소관부서</td>
	            <td width="123" class="tbl_fieldc">담당자</td>					
	            <td width="123" class="tbl_fieldc">업체선정평가<br>기준표</td>					
	          </tr> 
	          <c:forEach var="row" items="${list3}" varStatus="status" end="10">
	          <tr>
	            <td width="120" class="tbl_list_center">${row.CNRT_NM}</td>
	            <td width="101" class="tbl_list_center"><c:out value="${fn:substring(row.CNRT_YEAR,0,4)}"/>.<c:out value="${fn:substring(row.CNRT_YEAR,4,6)}"/></td>
	            <td width="312" class="tbl_list_center">${fn:replace(row.CNRT_CHOOSE_REASON, crcn, br)}</td>
	            <td width="171" class="tbl_list_center">${row.CNRT_DEPT_NM}</td>
	            <td width="123" class="tbl_list_center">${row.CNRT_PERSON_NM}</td>	          
	            <td width="123" class="tbl_list_center">
	            <c:choose> 
				    <c:when test="${row.ATTACH eq 'Y'}">
				    
					     <input type='hidden' name='FID' id='FID2' value="${row.FID}">
				         <a href='#this' name='filenm3' ><img src="/scms/images/ico_att.gif" align="absmiddle"></a>
				    </c:when>
				</c:choose>    
	            </td>	          
	          </tr>
	          ...
	          <tr>
	            <td width="100%" colspan="6" class="tbl_fieldT">	            	            
		            ...
		            <td width="15%" align="right"><a href="#this" class="w_btn" id="eval">등록</a> &nbsp;</td>
		            </tr>
		            </table>
	            </td>	           							
	           </tr>
              ...
              <td>
                <table border="0" cellspacing="0" cellpadding="0" class="btn" id="changebtn2" style="display:block;">
                  <tr>
                    ...
                    <td background="/scms/images/btn_type0_bg.gif" class="btn_type1" nowrap><a href="#this" class="btn" id="reg"><font color="white">등록/수정</font></a></td>
