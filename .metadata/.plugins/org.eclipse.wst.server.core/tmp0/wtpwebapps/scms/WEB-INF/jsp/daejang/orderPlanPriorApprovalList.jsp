...
<script type="text/javascript">
	    ...
	    function orderPlanPriorApprovalDetail(obj){
			var comSubmit = new ComSubmit();
			...
			comSubmit.setUrl("<c:url value='/daejang/orderPlanPriorApprovalDetail.do' />");			
			comSubmit.submit();
		}
		...
		function fn_selectPrvCnrtPlanList(pageNo){
			...
			comAjax.setUrl("<c:url value='/daejang/orderPlanPriorApprovalListTe.do' />");
...
// 					    	   testSt = "<td><a href='#this' name='testBtA'><input type='hidden' name='title' id='UID' value=" + value.ID + "><input type='button' name='title' id='testM' value='승인'></a></td>"; 
						   ...
						   str += "<tr class=\"" + tr_class + "\">" + 
						   			   "<td>" + value.RNUM  + "</td>" +						   			                
						   			   "<td>" + 
						   			   dv_yrmonth(NvlStr(value.SAUP_YEAR), '.') +
						   		 ...
						   		 "</td>" +
// 						   			   "<td class=\"list_center_sht\">" +
// 						   			   CutString(NvlStr(value.SAUP_NM), 18)+
// 						   			   "<input type='hidden' name='title' id='UID' value=" + value.ID + ">" + 
// 						   			   "</td>" +
						   			   ...
						   			   testSt + 
// 						   			   "<td><a href='#this' name='testBtA'><input type='button' name='title' id='UID' value=" + value.ID + "></a></td>" + 
// 						   			   "<td>" + "<a href='#this' name='testBtA'><input type='button' name='testBt' id='testBt' value=\"승인\" >" + "</a></td>" + 
					                   "</tr>";					    
				...
				$("a[name='title']").on("click", function(e){ //제목 
					e.preventDefault();
					orderPlanPriorApprovalDetail($(this));
				});
				
				$("a[name='testBtA']").on("click", function(e){ //제목 
					e.preventDefault();
