...
<script type="text/javascript">
		...
		function fn_docIssueReserveList(){
...
<table  border="0" cellspacing="0" cellpadding="0" class="bodyframe_full">
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td class="pupup_title"><img src="/service/images/popup_title.gif" align="absmiddle">주요사업 데이터 등록</td>
      </tr>
      <tr>
    ...
    <!--페이지 타이틀 끝 -->
	 ...
	 <tr>
		...
		<table border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td class="title"><img src="/service/images/title_ico.gif" align="absmiddle">기본정보수정</td>
			</tr>
		</table>
		</td>				
	</tr>
              ...
              <tr>
                ...
                <table border="0" cellspacing="0" cellpadding="0" class="btn" id="tblAddMemo21" style="filter:none;">
                  <tr>
                    ...
                    <td background="/service/images/btn_type0_bg.gif" class="btn_type1" nowrap><a href="#this" class="btn" id="update"><font color="white">수정</font></a></td>
                ...
                <table border="0" cellspacing="0" cellpadding="0" class="btn" id="tblAddMemo21" style="filter:none;">
                  <tr>
                    <td><img src="/service/images/btn_type0_head.gif"></td>
                    <td background="/service/images/btn_type0_bg.gif" class="btn_type1" nowrap><a href="#this" class="btn" id="del"><font color="white">삭제</font></a></td>
                    <td><img src="/service/images/btn_type0_end.gif"></td>
                  </tr>
                </table>                
                </td>				               
                ...
                <table border="0" cellspacing="0" cellpadding="0" class="btn" id="tblAddMemoTempSave21" style="filter:none;">
                  <tr>
                    <td><img src="/service/images/btn_type1_head.gif"></td>
                    <td background="/service/images/btn_type1_bg.gif" class="btn_type1" nowrap><a href="#this" class="btn" id="list">목록</a></td>
                    <td><img src="/service/images/btn_type1_end.gif"></td>
                  </tr>
                </table>   
                </td>                               
              </tr>
