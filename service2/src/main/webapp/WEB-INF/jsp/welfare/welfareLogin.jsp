...
//     		{
//     			alert("복지급여 신청관리 지정관리자가 아닙니다.");
//     			return false;
//     		}
			var comSubmit = new ComSubmit("form1");
			comSubmit.target("_top");				
			comSubmit.setUrl("<c:url value='/welfare/welfareLoginList.do' />");
			comSubmit.submit();
		}
	</script>
</head>
                ...
                <div class="login-wrap">
                    <div class="login-content">
                        <div class="login-logo">
							<a href="#this" class="btn" id="logout"><img src="/service/images/popup_title.gif" align="absmiddle"></a>복지급여 신청관리
                        </div>
