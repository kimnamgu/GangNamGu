...
<table  border="0" cellspacing="0" cellpadding="0" class="bodyframe_full">
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td class="pupup_title"><img src="/service/images/popup_title.gif" align="absmiddle">주요사업 관리시스템</td>
      </tr>
      <tr>
              ...
              <tr>
                ...
                <table border="0" cellspacing="0" cellpadding="0" class="btn" id="changebtn2" style="display:block;">
                  <tr>
                    ...
                    <td background="/service/images/btn_type0_bg.gif" class="btn_type1" nowrap><a href="#this" class="btn" id="mod"><font color="white">수정</font></a></td>
