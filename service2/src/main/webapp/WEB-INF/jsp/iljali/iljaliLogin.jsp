...
<script type="text/javascript">
		...
		function fn_login(){
			...
			comSubmit.setUrl("<c:url value='/common/iljaliLogin.do' />");
			comSubmit.submit();
		}
	</script>
</head>
                ...
                <div class="login-wrap">
                    <div class="login-content">
                        <div class="login-logo">
							<a href="#this" class="btn" id="logout"><img src="/service/images/popup_title.gif" align="absmiddle"></a>일자리 컨텐츠 내역 조회
                        </div>
